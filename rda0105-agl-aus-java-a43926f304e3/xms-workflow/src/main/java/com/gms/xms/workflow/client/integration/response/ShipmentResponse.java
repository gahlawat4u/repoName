...
public class ShipmentResponse extends BaseResponse {
    ...
    public String toString() {
        return "ShipmentResponse [reciveAddress=" + reciveAddress + ", senderAddress=" + senderAddress + ", webshipQuoteLog=" + webshipQuoteLog + ", listWebshipQuoteLogDetail=" + listWebshipQuoteLogDetail + ", listQuotePiece=" + listQuotePiece + ", quoteId=" + quoteId + "]";
    }
