...
/**
 * Posted from GetListCountryOriginTask
 * <p>
 * Author TANDT
 */
public class GetListCountryOriginTask implements Task2 {
    private static final Log log = LogFactory.getLog(GetListCountryOriginTask.class);
    ...
    public boolean execute(ContextBase2 context) throws Exception {
        try {
            ...
            context.put(Attributes.COUNTRY_LIST_RESULT, countryModels);
        } catch (Exception e) {
