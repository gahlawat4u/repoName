...
/**
 * Posted from May 18, 2016 4:58:20 PM
 * <p>
 * Author huynd
 */
public class GetDhlIntlBaseChargeBaseTask implements Task2 {
    private static final Log log = LogFactory.getLog(GetDhlIntlBaseChargeBaseTask.class);
    ...
    public boolean execute(ContextBase2 context) throws Exception {
        try {
            ...
            rowName = MathUtils.shipmentWeightRound(rowName, false);
