...
/**
 * Posted from Jun 21, 2016 4:48:11 PM
 * <p>
 * Author huynd
 */
public class PrepareStartrackScheduleCollectionTask implements Task2 {
    private static final Log log = LogFactory.getLog(PrepareStartrackScheduleCollectionTask.class);
    ...
    public boolean execute(ContextBase2 context) throws Exception {
        try {
            ...
            startrackShipmentRequestVo.setShipmentInfo(shipmentInfoVo);
            ...
            startrackShipmentRequestVo.setScheduleCollection(scheduleCollectionVo);
