...
import com.gms.xms.workflow.task2.tnt.international.booking.PrepareTntIntlSaveShipmentDataTask;
...
public class ProcessSaveScheduleCollectionTask implements Task2 {
    private static final Log log = LogFactory.getLog(PrepareTntIntlSaveShipmentDataTask.class);
