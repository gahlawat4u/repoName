...
/**
 * Posted from GenFileViewManifestPriorityTask
 * <p>
 * Author TANDT
 */
public class GenFileViewManifestPriorityTask implements Task2 {
    private static final Log log = LogFactory.getLog(GenFileViewManifestPriorityTask.class);
