 ...
 * Author TANDT
 */
public class ProcessTntIntlSaveShipmentDataTask implements Task2 {

    private static final Log log = LogFactory.getLog(ProcessTntIntlSaveShipmentDataTask.class);
    ...
    public boolean execute(ContextBase2 context) throws Exception {
        ...
        try {
            ...
            if (selCollection == 1) {
                ...
                context2.put(Attributes.WFP_NAME, "Wfl-TntIntlScheduleCollection");
