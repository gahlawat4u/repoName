 ...
 * @author tkvcl
 */
public class GetTollIpecBaseChargeTask implements Task {
    ...
    public boolean execute(ContextBase context) throws Exception {
        try {
            ...
            TollIpecTotalRateVo tollIpecTotalRateVo = AppUtils.getObjectFromContext(context, Attributes.TOLL_RATE_SHEET, TollIpecTotalRateVo.class);
            ...
            tFilter.setFromZone(context.get(Attributes.SENDER_ZONE_CODE));
            tFilter.setToZone(context.get(Attributes.RECEIVER_ZONE_CODE));
            ...
            String columnName = context.get(Attributes.SENDER_ZONE_CODE).concat("-").concat(context.get(Attributes.RECEIVER_ZONE_CODE));
            Double conRate = 0D;
            ...
            filter.setZone(context.get(Attributes.SENDER_ZONE_CODE).concat("-").concat(context.get(Attributes.RECEIVER_ZONE_CODE)));
           //code by rakesh sir (usedRateWebshipVo.getRate() == 0)
            ...
            context.put(Attributes.CARRIER_COST, String.valueOf(conRate));
