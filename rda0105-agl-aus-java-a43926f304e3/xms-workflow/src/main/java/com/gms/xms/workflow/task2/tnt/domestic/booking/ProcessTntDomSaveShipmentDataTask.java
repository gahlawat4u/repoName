 ...
 * Author TANDT
 */
public class ProcessTntDomSaveShipmentDataTask implements Task2 {

    private static final Log log = LogFactory.getLog(ProcessTntDomSaveShipmentDataTask.class);
    ...
    public boolean execute(ContextBase2 context) throws Exception {
        ...
        try {
            ...
            TntConnoteFilter tntConnoteFilter = new TntConnoteFilter();
            ...
            String connPrefix = SystemSettingCache.getInstance().getValueByKey("TNT Domestic Conn Number Prefix");
            tntConnoteFilter.setConnEnd(connEnd);
            tntConnoteFilter.setConnStart(connStart);
            tntConnoteFilter.setConnPrefix(connPrefix);
            tntConnoteFilter.setShipmentId(bookingDataVo.getShipmentVo().getShipmentId());
            tntConnoteService.insertTntConnote(addInfo, tntConnoteFilter);
            String airbillNumber = tntConnoteService.getConnNumber(tntConnoteFilter);
            ...
            if (selCollection == 1) {
                ...
                context2.put(Attributes.WFP_NAME, "Wfl-TntDomScheduleCollection");
