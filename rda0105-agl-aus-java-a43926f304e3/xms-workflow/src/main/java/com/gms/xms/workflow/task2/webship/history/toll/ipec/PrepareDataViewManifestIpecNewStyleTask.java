package com.gms.xms.workflow.task2.webship.history.toll.ipec;
...
/**
 * Posted from PrepareDataViewManifestIpecNewStyleTask
 * <p>
 * Author Thinhdd
 */
public class PrepareDataViewManifestIpecNewStyleTask implements Task2 {
    private static final Log log = LogFactory.getLog(PrepareDataViewManifestIpecNewStyleTask.class);
    ...
    public boolean execute(ContextBase2 context) throws Exception {
        try {
            ...
            String customerCode="";
            String senderInfo="";
            Integer forceVolWeight = ShipmentUtils.getForceVolWeight(59);
            int conNotes = 0;
            ...
            TollIpecManifestVo manifestByMainShipment = tollIpecManifestDao.getManifestByMainShipment(mainShipmentId.toString());
            List<String> shipmentIds = new ArrayList<>();
            String shipmentIdStr = null;
            if (manifestByMainShipment == null || shipmentMainInfoManifestVo.getStatus()==1) {
                ...
                manifestIdentifier = manifestByMainShipment.getManifestIdentifier().toString();
            ...
            ShipmentTypeVo shipmentTypeVo = shipmentTypeDao.selectById(shipmentMainInfoManifestVo.getShipmentTypeId());
            ...
            for (String shipmentId : shipmentIds) {
                ...
                if(shipmentInfoManifestVo.getStatus()==1 && shipmentIds.size()!=1)
                {
                    continue;
                }
                ...
                historyDetailShipmentModel.setsCompanyName(StringEscapeUtils.escapeXml(senderVo.getCompanyName()));
                historyDetailShipmentModel.setrCity(receiverVo.getCity());
                historyDetailShipmentModel.setrCompanyName(StringEscapeUtils.escapeXml(receiverVo.getCompanyName()));
            ...
            data.put("shipmentTypeName", shipmentTypeVo.getShipmentTypeName());
