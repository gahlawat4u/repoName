 ...
 */
public class ValidateUpsScheduleCollectionDataTask implements Task2 {
    private static final Log log = LogFactory.getLog(ValidateUpsScheduleCollectionDataTask.class);
