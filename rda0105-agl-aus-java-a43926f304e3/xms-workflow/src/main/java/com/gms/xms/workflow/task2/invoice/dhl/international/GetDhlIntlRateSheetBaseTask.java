...
/**
 * Posted from May 18, 2016 4:39:28 PM
 * <p>
 * Author huynd
 */
public class GetDhlIntlRateSheetBaseTask implements Task2 {
    private static final Log log = LogFactory.getLog(GetDhlIntlRateSheetBaseTask.class);
