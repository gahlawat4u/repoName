 ...
 * Author huynd
 */
public class GetTntIntlImportBillingRateSheetBaseTask implements Task2 {
    private static final Log log = LogFactory.getLog(GetTntIntlImportBillingRateSheetBaseTask.class);
