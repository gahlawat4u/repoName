...
/**
 * Posted from May 20, 2016 9:32:26 AM
 * <p>
 * Author huynd
 */
public class GetTollIpecBaseChargeBaseTask implements Task2 {
    private static final Log log = LogFactory.getLog(GetTollIpecBaseChargeBaseTask.class);
