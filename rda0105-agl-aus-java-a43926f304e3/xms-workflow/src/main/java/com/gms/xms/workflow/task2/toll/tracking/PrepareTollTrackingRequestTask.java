...
/**
 * Posted from PrepareTollTrackingRequestTask
 * <p>
 * Author TANDT
 */
public class PrepareTollTrackingRequestTask implements Task2 {

    private static final Log log = LogFactory.getLog(PrepareTollTrackingRequestTask.class);
