...
/**
 * Posted from GenFileViewAirbillTask
 * <p>
 * Author TANDT
 */
public class GenFileViewAirbillDomTask implements Task2 {
    private static final Log log = LogFactory.getLog(GenFileViewAirbillDomTask.class);
