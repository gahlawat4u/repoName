 ...
 */
public class GetFreezeCreditNoteDateListTask implements Task {
    private static final Log log = LogFactory.getLog(GetFreezeCreditNoteDateListTask.class);
    ...
    public boolean execute(ContextBase context) throws Exception {
        ...
        try {
            ...
            List<CreditNoteVo> creditNoteVos = creditNoteDao.selectFreezeCreditNoteDateList(creditNoteFilter);
