...
/**
 * Posted from CarrierAdjustmentPendingTask
 * <p>
 * Author TanDT Date Jun 1, 2015
 */
public class CarrierAdjustmentPendingTask implements Task {
    private static final Log log = LogFactory.getLog(CarrierAdjustmentPendingTask.class);
