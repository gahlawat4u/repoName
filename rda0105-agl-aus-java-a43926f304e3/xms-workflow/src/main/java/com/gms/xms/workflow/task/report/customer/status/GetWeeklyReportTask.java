...
/**
 * Posted from GetWeeklyReportTask
 * <p>
 * Author DatTV Nov 6, 2015
 */
public class GetWeeklyReportTask implements Task {
    private static final Log log = LogFactory.getLog(GetWeeklyReportTask.class);
    ...
    public boolean execute(ContextBase context) throws Exception {
        ...
        try {
            ...
            List<Map<String, String>> result = statusDao.getWeeklyReport(filter);
            // Puts result into the context
            context.put(Attributes.CUSTOMER_STATUS_WEEKLY_REPORT_RESULT, GsonUtils.toGson(result));
        } catch (Exception e) {
            log.error(e);
