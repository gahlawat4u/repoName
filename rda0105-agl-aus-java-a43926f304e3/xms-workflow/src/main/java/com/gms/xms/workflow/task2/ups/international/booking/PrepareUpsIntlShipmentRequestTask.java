 ...
 * Author TANDT
 */
public class PrepareUpsIntlShipmentRequestTask implements Task2 {
    private static final Log log = LogFactory.getLog(PrepareUpsIntlShipmentRequestTask.class);
    ...
    public boolean execute(ContextBase2 context) throws Exception {
        try {
            ...
            tntShipmentRequestVo.setServiceCode(serviceCode);
            context.put(Attributes.UPS_SHIPMENT_REQUEST_VO, tntShipmentRequestVo);
