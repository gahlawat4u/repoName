 ...
 * Author TANDT
 */
public class GenFileViewCommercialInvoiceTask implements Task2 {
    private static final Log log = LogFactory.getLog(GenFileViewCommercialInvoiceTask.class);
    ...
    public boolean execute(ContextBase2 context) throws Exception {
        try {
            ...
            String shipmentId = request.getShipmentId().toString();
