 ...
 */
public class PrepareCancelTntDomScheduleCollectionTask implements Task2 {
    private static final Log log = LogFactory.getLog(PrepareCancelTntDomScheduleCollectionTask.class);
    ...
    public boolean execute(ContextBase2 context) throws Exception {
        ...
        dataMapping.put("reasonCode", reason);
