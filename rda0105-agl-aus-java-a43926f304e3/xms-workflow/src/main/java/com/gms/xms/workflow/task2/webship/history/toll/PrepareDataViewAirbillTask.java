...
public class PrepareDataViewAirbillTask implements Task2 {
    ...
    public boolean execute(ContextBase2 context) throws Exception {
        try {
            ...
            InputStream tntIS = new ClassPathResource("templates/pdf/history/tnt.png").getInputStream();
            byte[] imgBytesAsBase64TntDefault = Base64.encodeBase64(IOUtils.toByteArray(tntIS));
