...
/**
 * Posted from Jun 23, 2016 2:29:36 PM
 * <p>
 * Author huynd
 */
public class PrepareRateSheetRowTask implements Task2 {
    ...
    public boolean execute(ContextBase2 context) throws Exception {
        try {
            ...
            List<String> checkRow = new LinkedList<String>();
            ...
            for (int i = 0; i < rowData.size(); i++) {
                ...
                rowName = rowMap.get(StarTrackConstants.ORIGIN_ZONE);
                if (!checkRow.contains(rowName)) {
                    ...
                    rowDataModel.setZoneName(rowMap.get(StarTrackConstants.ORIGIN_ZONE_NAME));
                    rowDataList.add(rowDataModel);
                    checkRow.add(rowName);
                }
            }
