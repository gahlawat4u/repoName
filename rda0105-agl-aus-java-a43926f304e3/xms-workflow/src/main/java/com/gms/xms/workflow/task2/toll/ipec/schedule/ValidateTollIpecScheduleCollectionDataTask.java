...
/**
 * Posted from ValidateTntDomScheduleCollectionDataTask
 * <p>
 * Author @author HungNT Feb 3, 2016
 */
public class ValidateTollIpecScheduleCollectionDataTask implements Task2 {
    private static final Log log = LogFactory.getLog(ValidateTollIpecScheduleCollectionDataTask.class);
