 ...
 * Author TANDT
 */
public class PrepareDataForVoidShipmentTask implements Task2 {
    private static final Log log = LogFactory.getLog(PrepareDataForVoidShipmentTask.class);
    ...
    public boolean execute(ContextBase2 context) throws Exception {
        try {
            ...
            context.put(Attributes.DHL_VOID_SHIPMENT_REQUEST, cancelPickupRequestVo);
        } catch (Exception e) {
