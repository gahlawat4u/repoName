...
import com.gms.xms.persistence.dao.CarrierAdjustmentAcceptSubmittedDaoService;
...
/**
 * Posted from CarrierAdjustmentSubmittedTask
 * <p>
 * Author TanDT Date Jun 1, 2015
 */
public class CarrierAdjustmentSubmittedTask implements Task {
    private static final Log log = LogFactory.getLog(CarrierAdjustmentSubmittedTask.class);
    private CarrierAdjustmentAcceptSubmittedDaoService dao = new CarrierAdjustmentAcceptSubmittedDaoService();
    ...
    public boolean execute(ContextBase context) throws Exception {
        try {
            ...
            if (e.getClass() == CustomException.class) {
                context.put(Attributes.ERROR_TYPE, AppConstants.CUSTOM_ERROR_MESSAGE);
            }
