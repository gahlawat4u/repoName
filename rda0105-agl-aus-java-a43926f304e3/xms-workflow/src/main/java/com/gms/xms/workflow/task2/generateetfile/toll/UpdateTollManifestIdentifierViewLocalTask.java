 ...
 * Author huynd
 */
public class UpdateTollManifestIdentifierViewLocalTask implements Task2 {
    private static final Log log = LogFactory.getLog(UpdateTollManifestIdentifierViewLocalTask.class);
