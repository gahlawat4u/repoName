...
/**
 * Posted from Jul 22, 2016 5:12:11 PM
 * <p>
 * Author huynd
 */
public class GetStartrackImportBillingBaseChargeBaseTask implements Task2 {
    private static final Log log = LogFactory.getLog(GetStartrackImportBillingBaseChargeBaseTask.class);
    ...
    public boolean execute(ContextBase2 context) throws Exception {
        try {
            ...
            customerBaseRateFilter.setCustomerCode(saveImportBillingVo.getCustomerCode());
            ...
            customerVo = customerDao.selectMinimumBaseChargeByCustomerCode(saveImportBillingVo.getCustomerCode());
            if (customerVo != null) {
            ...
            if ("road express".equalsIgnoreCase(shipmentTypeVo.getShipmentTypeName()) || "premium air freight".equalsIgnoreCase(shipmentTypeVo.getShipmentTypeName())) {
                ...
                cRate = cRateArr != null ? Collections.min(cRateArr) : 0.0;
                ncRate = ncRateArr != null ? Collections.min(ncRateArr) : 0.0;
            } else {
