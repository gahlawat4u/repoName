 ...
 * @author tkvcl
 */
public class GetFollowmontTransportRateSheetTask implements Task {
    private static final Log log = LogFactory.getLog(GetFollowmontTransportRateSheetTask.class);
