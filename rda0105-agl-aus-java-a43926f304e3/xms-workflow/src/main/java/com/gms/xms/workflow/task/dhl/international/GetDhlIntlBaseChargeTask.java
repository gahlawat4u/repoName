 ...
 */
public class GetDhlIntlBaseChargeTask implements Task {
    ...
    public boolean execute(ContextBase context) throws Exception {
        try {
            ...
            DhlRateSheetsVo dhlRateSheetsVo = GsonUtils.fromGson(context.get(Attributes.DHL_RATE_SHEET), DhlRateSheetsVo.class);
            ...
            context.put(Attributes.CUSTOMER_BASE_RATE, GsonUtils.toGson(customerBaseRateVo));
