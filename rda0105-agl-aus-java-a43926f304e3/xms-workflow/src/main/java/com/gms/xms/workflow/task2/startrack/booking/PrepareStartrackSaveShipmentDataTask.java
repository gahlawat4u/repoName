...
/**
 * Posted from Jun 15, 2016 2:31:13 PM
 * <p>
 * Author huynd
 */
public class PrepareStartrackSaveShipmentDataTask implements Task2 {
    private static final Log log = LogFactory.getLog(PrepareStartrackSaveShipmentDataTask.class);
    ...
    public boolean execute(ContextBase2 context) throws Exception {
        ...
        try {
            ...
            Integer selPackingList = context.getInt(Attributes.PACKAGE_LIST_RESULT);
    ...
    private ShipmentVo buildShipmentVo(ShipmentRequestVo shipmentRequestPage1, ShipmentRequestVo shipmentRequestPage2) throws Exception {
        ...
        shipmentVo.setBillingAccount(SystemSettingCache.getInstance().getValueByKey("StarTrack Account"));
