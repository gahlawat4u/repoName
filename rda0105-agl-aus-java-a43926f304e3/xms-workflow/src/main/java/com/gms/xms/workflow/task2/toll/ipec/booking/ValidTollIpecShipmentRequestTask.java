...
/**
 * Posted from ValidTollIpecShipmentRequestTask
 * <p>
 * Author @author HungNT Feb 16, 2016
 */
public class ValidTollIpecShipmentRequestTask implements Task2 {
    private static final Log log = LogFactory.getLog(ValidTollIpecShipmentRequestTask.class);
