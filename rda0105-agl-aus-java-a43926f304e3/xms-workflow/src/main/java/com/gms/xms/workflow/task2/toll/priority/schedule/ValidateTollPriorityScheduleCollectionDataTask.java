...
/**
 * Posted from ValidateTollPriorityScheduleCollectionDataTask
 * <p>
 * Author @author HungNT Feb 17, 2016
 */
public class ValidateTollPriorityScheduleCollectionDataTask implements Task2 {
    private static final Log log = LogFactory.getLog(ValidateTollPriorityScheduleCollectionDataTask.class);
