 ...
 * Author TANDT
 */
public class ValidOtherCarrierShipmentRequestTask implements Task2 {
    private static final Log log = LogFactory.getLog(ValidOtherCarrierShipmentRequestTask.class);
