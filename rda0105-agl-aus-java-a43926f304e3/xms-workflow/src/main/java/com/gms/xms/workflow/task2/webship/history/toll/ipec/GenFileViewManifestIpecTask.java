...
/**
 * Posted from GenFileViewManifestIpecTask
 * <p>
 * Author Thinhdd
 */
public class GenFileViewManifestIpecTask implements Task2 {
    private static final Log log = LogFactory.getLog(GenFileViewManifestIpecTask.class);
