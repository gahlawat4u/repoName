 ...
 * Author huynd
 */
public class UpdateTollByCustomerManifestIdentifierTask implements Task2 {
    private static final Log log = LogFactory.getLog(UpdateTollByCustomerManifestIdentifierTask.class);
            ...
            if (!StringUtils.isBlank(fileName) && file.isFile()) {
                ...
                if (manifestId != 0) {
                    ...
                    for (String shipmentId : shipmentIdArr) {
                        ...
                        tollConnoteDao.updateConnoteGenManifest(addInfo,shipmentId);
