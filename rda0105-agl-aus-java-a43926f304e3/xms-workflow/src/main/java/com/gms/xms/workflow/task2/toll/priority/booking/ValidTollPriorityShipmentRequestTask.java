...
/**
 * Posted from ValidTollPriorityShipmentRequestTask
 * <p>
 * Author @author HungNT Feb 16, 2016
 */
public class ValidTollPriorityShipmentRequestTask implements Task2 {
    private static final Log log = LogFactory.getLog(ValidTollPriorityShipmentRequestTask.class);
    ...
    public boolean execute(ContextBase2 context) throws Exception {
        ...
        try {
            ...
            if (shipmentRequestPage1.getQuote() == null || StringUtils.isEmpty(String.valueOf(shipmentRequestPage1.getQuote().getTotalCustomValue()))) {
