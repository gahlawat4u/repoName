...
/**
 * Posted from SumMonthlyReportTask
 * <p>
 * Author DatTV Dec 17, 2015
 */
public class SumMonthlyReportTask implements Task {
    private static final Log log = LogFactory.getLog(SumMonthlyReportTask.class);
    ...
    public boolean execute(ContextBase context) throws Exception {
        ...
        try {
            // Do DAO service to get monthly summary for customer status report.
            Map<String, String> result = statusDao.sumMonthlyReport(filter);
            // Puts result into the context
            context.put(Attributes.CUSTOMER_STATUS_MONTHLY_TOTAL_RESULT, GsonUtils.toGson(result));
        } catch (Exception e) {
            log.error(e);
