...
/**
 * Posted from SumCustomerAgingByFilterTask
 * <p>
 * Author DatTV Date Aug 13, 2015 5:11:43 PM
 */
public class SumCustomerAgingByFilterTask implements Task {
    private static final Log log = LogFactory.getLog(SumCustomerAgingByFilterTask.class);
    ...
    public boolean execute(ContextBase context) throws Exception {
        ...
        try {
            ...
            CustomerAgingVo result = customerAgingDao.sumByFilter(filter);

            // Puts result into the context
            context.put(Attributes.CUSTOMER_AGING_TOTAL_RESULT, GsonUtils.toGson(result));
        } catch (Exception e) {
