...
public class GetUnfrozenPeriodListTask implements Task {
    private static final Log log = LogFactory.getLog(GetUnfrozenPeriodListTask.class);
    ...
    public boolean execute(ContextBase context) throws Exception {
        ...
        try {
            ...
            // Do DAO service to get list of Unfrozen Franchise Payable Report
            List<FranchisePayablePeriodVo> fpbPeriodList = fpbPeriodDao.getUnfrozenFranchisePayableReport();
