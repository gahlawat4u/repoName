...
/**
 * Posted from PrepareWebshipCustomerHistoryReportTask.java
 * <p>
 * Author dattrinh 2:07:42 PM
 */
public class PrepareWebshipCustomerHistoryReportTask implements Task {
    private static final Log log = LogFactory.getLog(PrepareWebshipCustomerHistoryReportTask.class);
    ...
    public boolean execute(ContextBase context) throws Exception {
        ...
        try {
            ...
            if (AppConstants.NO_FLAG.equalsIgnoreCase(hasCache)) {
                dao.prepareWebshipCustomerHistoryReport(addInfo, filter);
            }
        } catch (Exception e) {
            log.error(e);
