package com.gms.xms.workflow.task2.generateetfile.toll.manifest;
 ...
 * Author huynd
 */
public class GetTollShipmentByCustomerListTask implements Task2 {
    private static final Log log = LogFactory.getLog(GetTollShipmentByCustomerListTask.class);
    ...
    public boolean execute(ContextBase2 context) throws Exception {
        try {
            ...
            List<TollShipmentVo> tollShipmentVos = tollConnoteDao.getTollShipmentByCustomerGenerateList(customerCode);
