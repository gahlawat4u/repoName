...
/**
 * Posted from May 19, 2016 5:13:43 PM
 * <p>
 * Author huynd
 */
public class GetTntDomesticRateSheetBaseTask implements Task2 {
    private static final Log log = LogFactory.getLog(GetTntDomesticRateSheetBaseTask.class);
