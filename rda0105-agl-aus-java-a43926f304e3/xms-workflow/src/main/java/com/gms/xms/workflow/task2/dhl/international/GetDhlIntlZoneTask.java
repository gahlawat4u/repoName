 ...
 */
public class GetDhlIntlZoneTask implements Task2 {
    ...
    public boolean execute(ContextBase2 context) throws Exception {
        ...
        try {
            ...
            WebshipLoginVo webshipLogin = context.get(Attributes.USER_LOGGIN_INFO);
            ...
            if ((shipmentTypeVo.getShipmentTypeName().contains("ESI") || shipmentTypeVo.getShipmentTypeName().contains("ECONOMY SELECT")) && (shipmentInfoVo.getTotalWeight() < 10 || shipmentInfoVo.getContents() == 0)) {
                context.put(Attributes.ERROR_CODE, ErrorCode.ERROR);
                context.put(Attributes.ERROR_MESSAGE, "Total weight have to be larger than 10kgs and cannot be document.");
                return false;
            }
            ...
            if (bound == 1) {
                ...
                if (StringUtils.equalsIgnoreCase(shipmentInfoVo.getSenderAddress().getState(), "WA") && defaultCountryId.equalsIgnoreCase("16") && (receiverAddress.getCountry() == 181 || receiverAddress.getCountry() == 150)) {
