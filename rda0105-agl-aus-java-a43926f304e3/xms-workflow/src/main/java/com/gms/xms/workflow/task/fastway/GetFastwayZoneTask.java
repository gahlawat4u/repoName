package com.gms.xms.workflow.task.fastway;
 ...
 * @author tkvcl
 */
public class GetFastwayZoneTask implements Task {
    private static final Log log = LogFactory.getLog(GetFastwayZoneTask.class);
