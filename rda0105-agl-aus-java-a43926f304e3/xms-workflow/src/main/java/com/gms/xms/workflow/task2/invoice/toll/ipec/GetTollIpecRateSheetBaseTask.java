...
/**
 * Posted from May 20, 2016 9:29:54 AM
 * <p>
 * Author huynd
 */
public class GetTollIpecRateSheetBaseTask implements Task2 {
    private static final Log log = LogFactory.getLog(GetTollIpecRateSheetBaseTask.class);
