...
import com.gms.xms.persistence.dao.CarrierAdjustmentRejectPendingDaoService;
...
/**
 * Posted from CarrierAdjustmentRejectPendingTask
 * <p>
 * Author TanDT Date Jun 1, 2015
 */
public class CarrierAdjustmentRejectPendingTask implements Task {
    private static final Log log = LogFactory.getLog(CarrierAdjustmentRejectPendingTask.class);
    private CarrierAdjustmentRejectPendingDaoService dao = new CarrierAdjustmentRejectPendingDaoService();
