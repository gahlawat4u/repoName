...
/**
 * Posted from Sep 27, 2016 3:58:08 PM
 * <p>
 * Author dattrinh
 */
public class FreezeFranchiseReceivableReportTask implements Task {
    private static final Log log = LogFactory.getLog(FreezeFranchiseReceivableReportTask.class);
