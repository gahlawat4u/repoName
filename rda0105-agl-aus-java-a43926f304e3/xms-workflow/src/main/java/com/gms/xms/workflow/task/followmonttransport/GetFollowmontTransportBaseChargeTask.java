 ...
 * @author tkvcl
 */
public class GetFollowmontTransportBaseChargeTask implements Task {
    private static final Log log = LogFactory.getLog(GetFollowmontTransportBaseChargeTask.class);
