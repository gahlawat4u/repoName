...
/**
 * Posted from PrepareTollIpecSaveShipmentDataTask
 * <p>
 * Author @author HungNT Feb 16, 2016
 */
public class PrepareTollIpecSaveShipmentDataTask implements Task2 {
    private static final Log log = LogFactory.getLog(PrepareTollIpecSaveShipmentDataTask.class);
    ...
    public boolean execute(ContextBase2 context) throws Exception {
        try {
            ...
            shipmentRequestPage2.getShipmentInfo().setPackingList(1);
            shipmentRequestPage2.getShipmentInfo().setCommercialInvoiceId(1);
    ...
    private ShipmentVo buildShipmentVo(ShipmentRequestVo shipmentRequestPage1, ShipmentRequestVo shipmentRequestPage2) throws Exception {
        ...
        shipmentVo.setBillingAccount(SystemSettingCache.getInstance().getValueByKey("TOLLIPEC-Third-Party-Billing-Account"));
        ...
        if (shipmentInfoVoPage1.getContentType() != null) {
            shipmentVo.setProductContentCode(shipmentInfoVoPage1.getContentType());
