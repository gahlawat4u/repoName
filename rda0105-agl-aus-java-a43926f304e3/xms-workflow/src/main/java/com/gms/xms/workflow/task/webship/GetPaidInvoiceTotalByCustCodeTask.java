 ...
 */
public class GetPaidInvoiceTotalByCustCodeTask implements Task {
    private static final Log log = LogFactory.getLog(GetPaidInvoiceTotalByCustCodeTask.class);
    ...
    public boolean execute(ContextBase context) throws Exception {
        ...
        try {
            InvoiceVo invoice = invoiceDao.getPaidInvoiceTotalByCustCode(filter);
            context.put(Attributes.PAID_INVOICE_TOTAL_RESULT, String.valueOf(GsonUtils.toGson(invoice)));
        } catch (Exception e) {
