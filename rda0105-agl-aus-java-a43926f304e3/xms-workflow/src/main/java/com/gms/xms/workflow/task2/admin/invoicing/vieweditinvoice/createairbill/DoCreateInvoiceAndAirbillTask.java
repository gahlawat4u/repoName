...
/**
 * Posted from May 23, 2016 3:54:20 PM
 * <p>
 * Author huynd
 */
public class DoCreateInvoiceAndAirbillTask implements Task2 {
    private static final Log log = LogFactory.getLog(DoCreateInvoiceAndAirbillTask.class);

    @Override
    public boolean execute(ContextBase2 context) throws Exception {
        try {
            context.put(Attributes.ERROR_CODE, ErrorCode.SUCCESS);
            InvoiceVo newInvoice = context.get(Attributes.INVOICE_VO);
            ...
            service.createInvoiceAndAirbillDo(addInfo, newInvoice, createAirbillResult, shipmentVo, shipmentInvoiceVo, iRecalculateCharge);
            context.put(Attributes.INVOICE_VO, newInvoice);
