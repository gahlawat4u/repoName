 ...
 * Author TANDT
 */
public class GenFileViewThermalLablePriorityTask implements Task2 {
    private static final Log log = LogFactory.getLog(GenFileViewThermalLablePriorityTask.class);
