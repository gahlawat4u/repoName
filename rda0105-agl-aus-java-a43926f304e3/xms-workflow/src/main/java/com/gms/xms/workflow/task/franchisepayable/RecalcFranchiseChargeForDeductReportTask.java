...
public class RecalcFranchiseChargeForDeductReportTask implements Task {
    private static final Log log = LogFactory.getLog(RecalcFranchiseChargeForDeductReportTask.class);
    ...
    public boolean execute(ContextBase context) throws Exception {
        ...
        try {
            if (!AppConstants.YES_FLAG.equalsIgnoreCase(context.getString(Attributes.HAS_CACHE_ID))) {
                ...
                // report.
                List<FranPabDeductVo> deductVos = pabDeductDao.getFranchiseChargeByRptTxnId(rptTxnId);
