...
/**
 * Posted from GenFileViewManifestDomTask
 * <p>
 * Author TANDT
 */
public class GenFileViewManifestDomTask implements Task2 {
    private static final Log log = LogFactory.getLog(GenFileViewManifestDomTask.class);
    ...
    public boolean execute(ContextBase2 context) throws Exception {
        try {
            ...
            fileViewName="tntDomViewManifestNew";
