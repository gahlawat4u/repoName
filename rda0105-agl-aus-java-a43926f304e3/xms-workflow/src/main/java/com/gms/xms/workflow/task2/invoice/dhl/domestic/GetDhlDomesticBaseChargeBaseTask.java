...
/**
 * Posted from May 19, 2016 3:44:39 PM
 * <p>
 * Author huynd
 */
public class GetDhlDomesticBaseChargeBaseTask implements Task2 {
    private static final Log log = LogFactory.getLog(GetDhlDomesticBaseChargeBaseTask.class);
