 ...
 */
public class ValidateTntDomScheduleCollectionDataTask implements Task2 {
    private static final Log log = LogFactory.getLog(ValidateTntDomScheduleCollectionDataTask.class);
