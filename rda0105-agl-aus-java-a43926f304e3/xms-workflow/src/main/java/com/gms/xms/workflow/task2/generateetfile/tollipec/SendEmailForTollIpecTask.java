...
/**
 * Posted from Sep 26, 2016 11:00:39 AM
 * <p>
 * Author huynd
 */
public class SendEmailForTollIpecTask implements Task2 {
    private static final Log log = LogFactory.getLog(SendEmailForTollIpecTask.class);
