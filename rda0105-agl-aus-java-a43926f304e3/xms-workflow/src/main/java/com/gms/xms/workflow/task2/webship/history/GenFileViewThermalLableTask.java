...
public class GenFileViewThermalLableTask implements Task2 {
    ...
    public boolean execute(ContextBase2 context) throws Exception {
        try {
            ...
            String htmlFilePath = AppConstants.APP_SETTINGS.getAppTmpPath() + "/" + fileViewName + shipmentId + miniTime + ".html";
            ...
            AppUtils.template2File(htmlFilePath, false, "templates/pdf/history/" + fileViewName + ".ftl", data);
