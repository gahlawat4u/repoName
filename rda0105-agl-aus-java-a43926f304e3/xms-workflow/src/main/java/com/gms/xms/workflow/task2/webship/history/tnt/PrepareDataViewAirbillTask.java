 ...
 * Author TANDT
 */
public class PrepareDataViewAirbillTask implements Task2 {
    private static final Log log = LogFactory.getLog(PrepareDataViewAirbillTask.class);
    ...
    public boolean execute(ContextBase2 context) throws Exception {
        try {
            ...
            if (historyDetailInfo.getSpecialDeliveryinst() == null) {
                historyDetailInfo.setSpecialDeliveryinst("");
            }
            ...
            detailInfoModel.setReferenceNo(StringEscapeUtils.escapeXml(detailInfoModel.getReferenceNo()));
