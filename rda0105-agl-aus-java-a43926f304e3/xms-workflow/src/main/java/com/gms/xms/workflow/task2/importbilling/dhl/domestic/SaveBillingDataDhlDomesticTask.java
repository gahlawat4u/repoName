package com.gms.xms.workflow.task2.importbilling.dhl.domestic;
...
/**
 * Posted from Aug 17, 2016 2:26:58 PM
 * <p>
 * Author huynd
 */
public class SaveBillingDataDhlDomesticTask implements Task2 {

    private static final Log log = LogFactory.getLog(SaveBillingDataDhlDomesticTask.class);
        ...
        try {
            ...
            for (int j = 0; j < billingRowData.size(); j++) {
                ...
                switch (description.toUpperCase()) {
                    case "FREIGHT CHARGE": // Basecharge
                        ...
                        ediDescription = product.substring(0, product.length() - 2);
                        ...
                        if (originTextArr.length > 1) {
                            senderAddress.setCity(originTextArr[Integer.valueOf(Attributes.CITY_NAME)]);
                        } else {
                        ...
                        if (destinationTextArr.length > 1) {
                            receiverAddress.setCity(destinationTextArr[Integer.valueOf(Attributes.CITY_NAME)]);
                        } else {
                        ...
                        billingBaseCharge.setBillingBound(false);
