...
public class GetParentFranchiseByCodeTask implements Task {
    private static final Log log = LogFactory.getLog(GetParentFranchiseByCodeTask.class);
    ...
    public boolean execute(ContextBase context) throws Exception {
        ...
        try {
            ...
            // Do DAO service to get parent franchise
            FranchiseInfoVo result = franchiseDao.getParentFranchiseByCode(franchiseCode);
