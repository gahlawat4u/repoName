...
/**
 * Posted from PrepareTollPrioritySaveShipmentDataTask
 * <p>
 * Author @author HungNT Feb 16, 2016
 */
public class PrepareTollPrioritySaveShipmentDataTask implements Task2 {
    private static final Log log = LogFactory.getLog(PrepareTollPrioritySaveShipmentDataTask.class);
