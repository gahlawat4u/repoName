...
/**
 * Posted from GetTotalPayableOfAWBTask
 * </p>
 *
 * @author hungnt - Nov 3, 2015
 */
public class GetTotalPayableOfAWBTask implements Task {
    private static final Log log = LogFactory.getLog(GetTotalPayableOfAWBTask.class);
    ...
    public boolean execute(ContextBase context) throws Exception {
        ...
        try {
            ...
            // Do DAO service to get total payable of an airbill
            AirbillAdjustmentRequestVo adjustmentRequestVo = adjustmentRequestDao.selectTotalPayableOfAWB(filter);
            ...
            context.put(Attributes.AIRBILL_TOTAL_PAYABLE, GsonUtils.toGson(adjustmentRequestVo));
        } catch (Exception e) {
