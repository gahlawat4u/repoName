 ...
 */
public class GetTollPriorityBaseChargeTask implements Task {
    ...
    public boolean execute(ContextBase context) throws Exception {
        try {
            ...
            String senderZone = context.get(Attributes.SENDER_ZONE_CODE);
            String receiverZone = context.get(Attributes.RECEIVER_ZONE_CODE);
