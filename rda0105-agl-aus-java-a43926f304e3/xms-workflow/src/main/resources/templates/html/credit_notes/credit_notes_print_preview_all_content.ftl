<#if listCreditNotes?has_content>
    <#list listCreditNotes as creditNote>
    <div class="portlet-body" style="padding:0px;">
        <div class="page-content" style="background:#FFF; min-height: none;">
            <div class="row">
                <div class="col-xs-3">
                    <table class="table" style="font-size:11px; ">
                        <tr>
                            <td class="td1 b8"><img src="${(logo)!" "}" width="100%" style="margin-top:-30px;"/></td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="row" style="margin-bottom:20px;">
                <div class="col-xs-5">
                    ...
                    ${(creditNote.creditNoteInfo.billingCity)!" "}, ${(creditNote.creditNoteInfo.countryName)!" "}
            ...
            <div class="row">
                <div class="col-xs-8 flr">
                    <table class="table table-bordered mg0" style="font-size:11px; ">
                        ...
                        <#if creditNote.gstSummary?has_content>
                            <#list creditNote.gstSummary as summary>
                                <tr>
                ...
                <div class="col-xs-11 flr">
                    <table class="table table-bordered table-hover mg0" style="font-size:11px; ">
                        ...
                        <tr>
                            <td colspan="6" class="text-right"><b>${lang.translate('GRAND TOTAL:')}</b></td>
                            <td align="right">${(currencySymbol)!"$"} ${(creditNote.creditNoteInfo.totalCredited)!"0.00"}</td>
                        </tr>
                    </table>
                    </br>
            ...
            <#if creditNote.invSignature?trim != ''>
                <div class="row">
                    <p style="text-align: center;">${(creditNote.invSignature)?html?replace("\n", "<br/>")!" "}</p>
                </div>
            </#if>
        </div>
    </div>
