...
<html>
<head>
    <title>${lang.translate('TNT Domestic Remote Area Print Preview')}</title>
    <style type="text/css">
        @page {
            size: A4;
        }
            ...
            <table>
                <tr>
                    <td align="center"><span
                            style="font-size: 14px; font-weight: bold">${lang.translate('TNT Domestic Remote Area')}</span>
                    </td>
