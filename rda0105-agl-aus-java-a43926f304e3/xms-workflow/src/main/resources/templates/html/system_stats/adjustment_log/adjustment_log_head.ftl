...
<html>
<head>
    <title>${lang.translate('Adjustment Log')}</title>
    <style type="text/css">
        @page {
            size: A4;
        }
            ...
            <table>
                <tr>
                    <td align="center"><span
                            style="font-size: 14px; font-weight: bold">${lang.translate('Adjustment Log')}</span></td>
...
<table class="border">
    <thead>
    <tr>
        <th>${lang.translate('User Name')}</th>
        <th>${lang.translate('Adj ID')}</th>
        <th>${lang.translate('Type')}</th>
        <th>${lang.translate('Airbill #')}</th>
        <th>${lang.translate('Customer #')}</th>
        <th>${lang.translate('Action Date')}</th>
