    ...
    <tr>
        ...
        <td colspan="2">
            <table class="border" style="margin-top: 20px">
                <thead>
                <tr>
                    <td bgcolor="#fff" align="center"><strong>${lang.translate('Credit Number')}</strong></td>
                    <td bgcolor="#fff" align="center"><strong>${lang.translate('Credit Date')}</strong></td>
                    <td bgcolor="#fff" align="center"><strong>${lang.translate('Customer #')}</strong></td>
                    <td bgcolor="#fff" align="center"><strong>${lang.translate('Credits')}</strong></td>
                    <td bgcolor="#fff" align="center"><strong>${lang.translate('Total Credited')}</strong></td>
                </tr>
                </thead>
                <tbody>
                <tr>
