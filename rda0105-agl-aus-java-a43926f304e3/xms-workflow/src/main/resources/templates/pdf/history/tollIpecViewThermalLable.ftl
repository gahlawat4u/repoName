                ...
                <tr>
                    <td>
                        <table style="width:100%;" border="0">
                            <tr>
                                <td style="font-size:12px;width:25%; text-align:left;">
                                    <b>${detailInfoModel.serviceName}</b></td>
                                <td style="font-size:11px;width:45%;">Connote No: ${detailInfoModel.tracking}</td>
                        ...
                        <table style="width:100%;" border="0">
                            <tr>
                                ...
                                <td style="font-size:10px;width:40%;text-align:left;">
                                    Total Weight: ${pic.weight} ${detailInfoModel.weightUnit} Kg<br/>
                                    Total Cube M3: ${pic.weight} ${detailInfoModel.weightUnit}<br/>
                                    Cubic (cm): ${pic.dimession}
                                </td>
                ...
                <tr>
                    <td>
                        <table border="0" style="width:100%;text-align:center;">
                            <tr>
                                <td style="width:100%;"><img width="170px" height="85px" alt="BARCODE"
