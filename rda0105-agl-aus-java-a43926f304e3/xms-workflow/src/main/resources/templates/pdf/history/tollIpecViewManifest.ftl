...
<center>
    <h1>Manifest Report for Toll Ipec <#if detailInfoModel.status == 1><i class="font-35 color-red">VOID</i></#if></h1>
</center>
<br/>
...
<#list pieces as piece>
    <tr>
        ...
        <td class="width-8pc">${piece.weight}</td>
...
<table class="width-100pc text-left ">
    ...
    <tr>
        <td colspan="5"><b>Total No. of ConNotes: ${totalPiece} </b></td>
        <td class="border-top border-bottom"><b>Total for Manifest</b></td>
        <td class="border-top border-bottom">${totalPiece}</td>
