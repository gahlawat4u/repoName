...
<center>
    <h1>Manifest Report for Toll IPEC <#if detailInfoModel.status == '1'><i class="font-35 color-red">VOID</i></#if>
    </h1>
</center>
<br/>
<hr class="border-black padding-margin-0"/>
<hr class="padding-margin-0"/>
<br/><b>Service: ${shipmentTypeName}</b><br/>
<br/>
<hr class="border-black padding-margin-0"/>
<hr class="padding-margin-0"/>
<br/>
<table class="width-100pc">
    <tr>
        ...
        <td>${detailInfoModel.customerCode}</td>
    </tr>
    <tr>
        <td class="width-10pc bold">Dispatch Date:</td>
        <td>${dispatchDate}</td>
        <td></td>
        <td>${senderInfo}</td>
    </tr>
...
<#list shipments as shipment>
    <tr>
        <td class="width-12pc">${shipment.connoteNumber}</td>
        <td class="width-15pc">${shipment.rCompanyName}</td>
        <td class="width-8pc">Sender</td>
        <td class="width-8pc">${customerCode}</td>
        <td class="width-14pc">${shipment.rCity}</td>
        <td class="width-8pc">${shipment.rPostalCode}</td>
        <td class="width-8pc">${shipment.noOfPieces}</td>
        <td class="width-8pc">${shipment.cubicWeight}</td>
        <td class="width-8pc">${shipment.deadWeight}</td>
        <td class="width-8pc">0.00</td>
        <td class="width-5pc">N</td>
    </tr>
    <tr>
        <td colspan="11" align="left">References: ${shipment.referenceNo}</td>
    </tr>
</#list>
</table>
<table class="width-100pc text-left ">
    ...
    <tr>
        <td colspan="5"><b>Total No. of ConNotes: ${shipCount} </b></td>
        ...
        <td class="border-top border-bottom">${detailInfoModel.dimWeight}</td>
        <td class="border-top border-bottom">${detailInfoModel.actualWeight}</td>
