...
<div class="landscapePage">
        ...
        <table>
            ...
            <tr>
                ...
                <td>:${detailInfoModel.noOfPieces} Weight : ${detailInfoModel.totalWeight}${detailInfoModel.weightUnit}
                    Insurance Value: ${detailInfoModel.withInsurance}  Invoice Value : ${currencyCode}</td>
            </tr>
        </table>
    </div>
    <div class="width-30pc float-right">
        <table>
            ...
            <tr>
                <td>Serv: ${detailInfoModel.serviceCode} <#if detailInfoModel.contents == "1">D<#else>
                    N</#if>   ${detailInfoModel.serviceType}</td>
            </tr>
            <tr>
                <td></td>
            </tr>
...
<div class="portraitPage">
    ...
    <div class="float-left width-70pc">
        <table>
            ...
            <tr>
                <td>Address</td>
                <td>:${detailInfoModel.sCompanyName} ${detailInfoModel.sAddress}, ${detailInfoModel.sCity}
