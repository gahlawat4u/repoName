...
/**
 * Posted from SystemSettingDefaultValueVo
 * <p>
 * Author TANDT 19-10-2015
 */
public class SystemSettingDefaultValueVo extends BaseVo {
    ...
    public String toString() {
        return "SystemSettingDefaultValueVo [key=" + key + ", value=" + value + ", dataSource=" + dataSource + ", inputDisplay=" + inputDisplay + ", textDisplay=" + textDisplay + ", filter=" + filter + "]";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        SystemSettingDefaultValueVo other = (SystemSettingDefaultValueVo) obj;
        if (dataSource == null) {
