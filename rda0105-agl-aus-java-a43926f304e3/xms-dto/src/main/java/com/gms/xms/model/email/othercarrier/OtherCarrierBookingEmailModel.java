package com.gms.xms.model.email.othercarrier;
...
/**
 * Posted from OtherCarrierBookingEmailModel
 * <p>
 * Author @author HungNT Feb 19, 2016
 */
public class OtherCarrierBookingEmailModel extends BaseModel {
    private static final long serialVersionUID = -2924921427674716196L;
    ...
    public String toString() {
        return "OtherCarrierBookingEmailModel [franchiseName=" + franchiseName + ", customerName=" + customerName + ", customerCode=" + customerCode + ", airbillNumber=" + airbillNumber + ", carrierName=" + carrierName + ", message=" + message + ", shipmentDate=" + shipmentDate + ", shipmentTypeName=" + shipmentTypeName + ", packageName=" + packageName + ", noOfPieces=" + noOfPieces + ", totalWeight=" + totalWeight + ", dimensions=" + dimensions + ", collectionInstruction="
                + collectionInstruction + ", insurance=" + insurance + ", senderAddress=" + senderAddress + ", receiverAddress=" + receiverAddress + "]";
    }
}
