package com.gms.xms.txndb.vo.email.othercarrier;
...
public class OtherCarrierBookingEmailVo extends BaseVo {
    private static final long serialVersionUID = -1131325178334690942L;
    ...
    public String toString() {
        return "TntDomBookingEmailVo [franchiseName=" + franchiseName + ", customerName=" + customerName + ", customerCode=" + customerCode + ", airbillNumber=" + airbillNumber + ", carrierName=" + carrierName + ", message=" + message + ", shipmentDate=" + shipmentDate + ", shipmentTypeName=" + shipmentTypeName + ", packageName=" + packageName + ", noOfPieces=" + noOfPieces + ", totalWeight=" + totalWeight + ", dimensions=" + dimensions + ", collectionInstruction=" + collectionInstruction
