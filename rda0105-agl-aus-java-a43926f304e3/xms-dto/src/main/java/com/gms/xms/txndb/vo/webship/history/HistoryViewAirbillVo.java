...
/**
 * Posted from HistoryViewAirbillVo
 * <p>
 * Author TanDT Date Jul 11, 2015
 */
public class HistoryViewAirbillVo extends BaseVo {
    ...
    public String toString() {
        return "HistoryViewAirbillVo [pieceBarcode=" + pieceBarcode + ", pieceBarcode2=" + pieceBarcode2 + ", pieceBarcode3=" + pieceBarcode3 + ", itemCode=" + itemCode + ", picesCount=" + picesCount + ", imageBarcode=" + imageBarcode + ", imageBarcode2=" + imageBarcode2 + ", imageBarcode3=" + imageBarcode3 + ", weight=" + weight + ", dimWeight=" + dimWeight + ", articleId=" + articleId + ", sortBin=" + sortBin + ", dimession=" + dimession + ", tntLogo=" + tntLogo
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        HistoryViewAirbillVo other = (HistoryViewAirbillVo) obj;
        if (articleId == null) {
