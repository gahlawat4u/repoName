...
/**
 * Posted from OverallFranchiseRankingModel.java
 * <p>
 * Author dattrinh 3:31:20 PM
 */
public class OverallFranchiseRankingModel extends BaseModel {
    ...
    public String toString() {
        return "OverallFranchiseRankingModel [rank=" + rank + ", franchiseCode=" + franchiseCode + ", territory=" + territory + ", activateCustomers=" + activateCustomers + ", activations=" + activations + ", shipments=" + shipments + ", weights=" + weights + ", revenueIncGst=" + revenueIncGst + ", revenueExcGst=" + revenueExcGst + ", revenuePerShipIncGst=" + revenuePerShipIncGst + ", revenuePerShipExcGst=" + revenuePerShipExcGst + ", franchiseCostIncGst=" + franchiseCostIncGst
                + ", franchiseCostExcGst=" + franchiseCostExcGst + ", marginIncGst=" + marginIncGst + ", marginExcGst=" + marginExcGst + ", marginPerShipIncGst=" + marginPerShipIncGst + ", marginPerShipExcGst=" + marginPerShipExcGst + ", marginPerWeightIncGst=" + marginPerWeightIncGst + ", marginPerWeightExcGst=" + marginPerWeightExcGst + "]";
    }
