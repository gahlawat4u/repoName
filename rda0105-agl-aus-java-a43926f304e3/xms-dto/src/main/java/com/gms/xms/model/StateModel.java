...
/**
 * Posted from StateModel
 * <p>
 * Author HungNT Date May 13, 2015
 */
public class StateModel extends BaseModel {
    private static final long serialVersionUID = 5100409747009690721L;
    ...
    public String toString() {
        return "StateModel [id=" + id + ", stateName=" + stateName + ", stateCode=" + stateCode + ", cityName=" + cityName + ", cityCode=" + cityCode + ", countryId=" + countryId + ", dhlZone=" + dhlZone + ", fromPostCode=" + fromPostCode + ", toPostCode=" + toPostCode + ", status=" + status + "]";
    }
