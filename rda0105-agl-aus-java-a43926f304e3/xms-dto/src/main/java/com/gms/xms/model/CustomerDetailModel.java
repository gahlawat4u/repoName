...
/**
 * Posted from CustomerDetailModel
 * <p>
 * Author DatTV Sep 1, 2015
 */
public class CustomerDetailModel extends CustomerModel {

    private static final long serialVersionUID = 8104360095971109435L;
    ...
    public String toString() {
        return "CustomerDetailModel [webshipGroupName=" + webshipGroupName + ", salesRepName=" + salesRepName + ", customerName=" + customerName + ", addressContactName=" + addressContactName + ", addressAddress1=" + addressAddress1 + ", addressAddress2=" + addressAddress2 + ", addressCity=" + addressCity + ", addressCountry=" + addressCountry + ", addressPostalCode=" + addressPostalCode + ", addressPhone=" + addressPhone + ", addressEmail=" + addressEmail + ", billingCustomerName="
    ...
    public void setInvoiceDays(String invoiceDays) {
