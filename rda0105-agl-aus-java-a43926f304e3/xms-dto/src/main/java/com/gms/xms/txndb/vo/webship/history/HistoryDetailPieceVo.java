 ...
 */
public class HistoryDetailPieceVo extends BaseVo {
    ...
    public String toString() {
        return "HistoryDetailPieceVo [pieces=" + pieces + ", deadWeight=" + deadWeight + ", dimension=" + dimension + ", cubicWeight=" + cubicWeight + "]";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        HistoryDetailPieceVo other = (HistoryDetailPieceVo) obj;
        if (cubicWeight == null) {
