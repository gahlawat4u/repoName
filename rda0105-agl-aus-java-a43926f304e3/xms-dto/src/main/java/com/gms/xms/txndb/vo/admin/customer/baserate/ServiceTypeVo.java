...
public class ServiceTypeVo extends BaseVo {
    ...
    private List<CustBaseRateVo> custBaseRates;
    ...
    public List<CustBaseRateVo> getCustBaseRates() {
        return custBaseRates;
    }

    public void setCustBaseRates(List<CustBaseRateVo> custBaseRates) {
    ...
    public String toString() {
        return "ServiceTypeVo [shipmentTypeId=" + shipmentTypeId + ", shipmentTypeName=" + shipmentTypeName + ", serviceId=" + serviceId + ", allowCarrier=" + allowCarrier + ", allowNonCarrier=" + allowNonCarrier + ", showStatus=" + showStatus + ", documentType=" + documentType + ", content=" + content + ", bound=" + bound + ", carrierDocRate=" + carrierDocRate + ", carrierDocInRate=" + carrierDocInRate + ", carrierPackRate=" + carrierPackRate + ", carrierPackPerWeightRate="
