...
public class HistoryModel extends BaseModel {
    ...
    private List<ShipmentDetailModel> shipmentDetails;

    public List<ShipmentDetailModel> getShipmentDetails() {
        return shipmentDetails;
    }

    public void setShipmentDetails(List<ShipmentDetailModel> shipmentDetails) {
    ...
    public String toString() {
        return "HistoryModel [shipmentId=" + shipmentId + ", serviceName=" + serviceName + ", voidStatus=" + voidStatus + ", airbillNumber=" + airbillNumber + ", createDate=" + createDate + ", timeStamp=" + timeStamp + ", shipDate=" + shipDate + ", noOfPieces=" + noOfPieces + ", shipmentType=" + shipmentType + ", packageName=" + packageName + ", weight=" + weight + ", dimensions=" + dimensions + ", total=" + total + ", withInsurance=" + withInsurance + ", schedule=" + schedule
                ...
                + ", serviceId=" + serviceId + ", schId=" + schId + "]";
    }
