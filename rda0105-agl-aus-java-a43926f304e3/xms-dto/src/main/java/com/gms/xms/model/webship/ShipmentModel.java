...
public class ShipmentModel extends BaseModel {
     ...
     *
     */
    private static final long serialVersionUID = -7194593512649785976L;
...
private List<String> upsAirbillNo ;
    ...
    public String getCommercialInvoiceId() {
        return commercialInvoiceId;
    }

    public void setCommercialInvoiceId(String commercialInvoiceId) {
    ...
    public String getRewiightWeight() {
        return rewiightWeight;
    }

    public void setRewiightWeight(String rewiightWeight) {
    ...
    public String getCarrierPayment() {
        return carrierPayment;
    }

    public void setCarrierPayment(String carrierPayment) {
	...
	public String toString() {
		return "ShipmentModel [shipmentId=" + shipmentId + ", customerCode=" + customerCode + ", webshipId=" + webshipId
