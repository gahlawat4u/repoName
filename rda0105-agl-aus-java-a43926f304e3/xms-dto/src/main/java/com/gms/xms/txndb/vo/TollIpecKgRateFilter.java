 ...
 * @author tkvcl
 */
public class TollIpecKgRateFilter extends BaseVo {
    /**
     *
     */
    ...
    public String toString() {
        return "TollIpecKgRateFilter [fromZone=" + fromZone + ", toZone=" + toZone + ", serviceTypeName=" + serviceTypeName + "]";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TollIpecKgRateFilter other = (TollIpecKgRateFilter) obj;
        if (fromZone == null) {
