...
/**
 * Posted from NullFranchisePayableSCCreditVo
 * <p>
 * Author DatTV Dec 10, 2015
 */
public class NullFranchisePayableSCCreditVo extends FranchisePayableSCCreditVo {

    private static final long serialVersionUID = 1L;

    public NullFranchisePayableSCCreditVo() {
        super();
