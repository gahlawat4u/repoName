 ...
 * @author tkvcl
 */
public class TollIpecZoneModel extends BaseModel {
    /**
     *
     */
    ...
    public String toString() {
        return "TollIpecZoneModel [business=" + business + ", country=" + country + ", state=" + state + ", postcode=" + postcode + ", townName=" + townName + ", zone=" + zone + ", local=" + local + ", scNr=" + scNr + ", scName=" + scName + "]";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TollIpecZoneModel other = (TollIpecZoneModel) obj;
        if (business == null) {
