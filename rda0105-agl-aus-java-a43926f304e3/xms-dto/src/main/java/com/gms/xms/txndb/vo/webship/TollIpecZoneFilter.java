 ...
 * @author tkvcl
 */
public class TollIpecZoneFilter extends BaseVo {
    /**
     *
     */
    private static final long serialVersionUID = 8618765312922773906L;
    ...
    public String toString() {
        return "TollIpecZoneFilter [postalCode=" + postalCode + ", cityName=" + cityName + ", postalCodeR=" + postalCodeR + ", cityNameR=" + cityNameR + "]";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TollIpecZoneFilter other = (TollIpecZoneFilter) obj;
        if (cityName == null) {
