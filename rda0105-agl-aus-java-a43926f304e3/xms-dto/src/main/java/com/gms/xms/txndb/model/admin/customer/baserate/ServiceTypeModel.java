...
/**
 * Posted from Apr 4, 2016 9:51:32 PM
 * <p>
 * Author dattrinh
 */
public class ServiceTypeModel extends BaseModel {
    ...
    private List<CustBaseRateModel> custBaseRates;
    ...
    public List<CustBaseRateModel> getCustBaseRates() {
        return custBaseRates;
    }

    public void setCustBaseRates(List<CustBaseRateModel> custBaseRates) {
        this.custBaseRates = custBaseRates;
    }
    ...
    public String toString() {
        return "ServiceTypeModel [shipmentTypeId=" + shipmentTypeId + ", shipmentTypeName=" + shipmentTypeName + ", serviceId=" + serviceId + ", allowCarrier=" + allowCarrier + ", allowNonCarrier=" + allowNonCarrier + ", showStatus=" + showStatus + ", documentType=" + documentType + ", content=" + content + ", bound=" + bound + ", carrierDocRate=" + carrierDocRate + ", carrierDocInRate=" + carrierDocInRate + ", carrierPackRate=" + carrierPackRate + ", carrierPackPerWeightRate="
                ...
                + ", nonCarrierPackPerWeightRate=" + nonCarrierPackPerWeightRate + ", nonCarrierPackInRate=" + nonCarrierPackInRate + ", nonCarrierPackInPerWeightRate=" + nonCarrierPackInPerWeightRate + ", nonCarrierPakRate=" + nonCarrierPakRate + ", nonCarrierPakPerWeightRate=" + nonCarrierPakPerWeightRate + ", nonCarrierPakInRate=" + nonCarrierPakInRate + ", nonCarrierPakInPerWeightRate=" + nonCarrierPakInPerWeightRate + ", custBaseRates=" + custBaseRates + ", zones=" + zones
