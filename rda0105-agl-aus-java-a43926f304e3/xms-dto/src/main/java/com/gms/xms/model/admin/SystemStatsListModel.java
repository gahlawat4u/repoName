 ...
 * @author TanDT
 */
public class SystemStatsListModel extends BaseModel {
    /**
     *
     */
    ...
    public String toString() {
        return "SystemStatsListModel [importDate=" + importDate + ", count=" + count + ", serviceName=" + serviceName + "]";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        SystemStatsListModel other = (SystemStatsListModel) obj;
        if (count == null) {
            if (other.count != null)
                return false;
