...
/**
 * Posted from Jun 15, 2016 2:36:18 PM
 * <p>
 * Author huynd
 */
public class StartrackShipmentRequestVo extends BaseVo {
    ...
    public String toString() {
        return "StartrackShipmentRequestVo [shipmentInfo=" + shipmentInfo + ", shipmentReference=" + shipmentReference + ", scheduleCollection=" + scheduleCollection + ", serviceCode=" + serviceCode + ", packageInfo=" + packageInfo + "]";
    }
}
