...
/**
 * Posted from CarrierAdjustmentRejectPendingDaoService
 * <p>
 * Author TanDT Date Jun 1, 2015
 */
public class CarrierAdjustmentRejectPendingDaoService {
    ...
    public void updateCarrierAdjustmentById(Map<String, String> context, Long userId, Long adjustmentId) throws DaoException {
        ...
        try {
            ...
            airbillAdjustmentVo.setStatus((byte) 5);
            ...
            adjustmentHistoryVo.setStatus(5);
