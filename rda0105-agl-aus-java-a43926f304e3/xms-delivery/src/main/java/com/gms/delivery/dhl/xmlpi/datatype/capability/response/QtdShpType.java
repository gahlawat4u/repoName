...
public class QtdShpType {
    ...
    public String toString() {
        return "QtdShpType [globalProductCode=" + globalProductCode + ", localProductCode=" + localProductCode + ", productShortName=" + productShortName + ", localProductName=" + localProductName + ", networkTypeCode=" + networkTypeCode + ", pOfferedCustAgreement=" + pOfferedCustAgreement + ", transInd=" + transInd + ", pickupDate=" + pickupDate + ", pickupCutoffTime=" + pickupCutoffTime + ", bookingTime=" + bookingTime + ", currencyCode=" + currencyCode + ", exchangeRate=" + exchangeRate
                + ", weightCharge=" + weightCharge + ", weightChargeTax=" + weightChargeTax + ", weightChargeTaxRate=" + weightChargeTaxRate + ", totalTransitDays=" + totalTransitDays + ", pickupPostalLocAddDays=" + pickupPostalLocAddDays + ", deliveryPostalLocAddDays=" + deliveryPostalLocAddDays + ", pickupNonDHLCourierCode=" + pickupNonDHLCourierCode + ", deliveryNonDHLCourierCode=" + deliveryNonDHLCourierCode + ", deliveryCheckpointReturn=" + deliveryCheckpointReturn + ", deliveryDate="
                + deliveryDate + ", deliveryTime=" + deliveryTime + ", deliveryTimeGMTOffset=" + deliveryTimeGMTOffset + ", dimensionalWeight=" + dimensionalWeight + ", weightUnit=" + weightUnit + ", pickupDayOfWeekNum=" + pickupDayOfWeekNum + ", destinationDayOfWeekNum=" + destinationDayOfWeekNum + ", qtdShpExChrg=" + qtdShpExChrg + ", pricingDate=" + pricingDate + ", shippingCharge=" + shippingCharge + ", totalTaxAmount=" + totalTaxAmount + ", qtdSInAdCur=" + qtdSInAdCur
                + ", weightChargeTaxDet=" + weightChargeTaxDet + "]";
    }
