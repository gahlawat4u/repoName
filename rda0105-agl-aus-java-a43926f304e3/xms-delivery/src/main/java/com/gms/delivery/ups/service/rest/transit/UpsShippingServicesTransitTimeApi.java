...
public class UpsShippingServicesTransitTimeApi {

	private static final Log log =LogFactory.getLog(UpsShippingServices.class);
	/**
	 * @param args
	 */
	public String getTransitTime(ShippingRequest shippingRequestVo) {
//		 String UPS_URL = "http://34.248.151.220/crm/webapi/ups/";
	//String UPS_URL = "http://52.77.254.46/crm/webapi/ups/";
		//String UPS_URL = "http://54.255.209.226/crm/webapi/ups/";
		String UPS_URL = "http://127.0.0.1:8080/crm/webapi/ups/";
