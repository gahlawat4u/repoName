...
<div class="col-lg-4">
    <table class="table" style="font-size: 11px;">
        ...
        <tr>
            ...
            <td class="td2"><s:property value="currencySymbol"/><s:property value="invoiceDetail.total"/></td>
        </tr>
        <tr>
            <td class="td1"><xms:localization text="Paid:"/></td>
            <td class="td2" data-detail-paid="<s:property value="invoiceDetail.customerPaid" />"><s:property
                    value="currencySymbol"/><s:property value="invoiceDetail.customerPaid"/></td>
        </tr>
        <tr>
            <td class="td1"><xms:localization text="Credit:"/></td>
            <td class="td2" data-detail-credit="<s:property value="invoiceDetail.creditTotal" />"><s:property
                    value="currencySymbol"/><s:property value="invoiceDetail.creditTotal"/></td>
        </tr>
        <tr>
            <td class="td1"><xms:localization text="Bad Debt:"/></td>
            <td class="td2"><s:property value="currencySymbol"/><s:property value="invoiceDetail.badDebt"/></td>
        </tr>
        <tr>
            <td class="td1"><xms:localization text="Satisfaction Credit:"/></td>
            <td class="td2"><s:property value="currencySymbol"/><s:property
                    value="invoiceDetail.satisfactionCredit"/></td>
        </tr>
        <tr>
            <td class="td1"><xms:localization text="Owed:"/></td>
            <td class="td2" data-detail-owed=""><s:property value="currencySymbol"/><s:property
                    value="invoiceDetail.owed"/></td>
        </tr>
    </table>
...
<div class="col-lg-4">
    <table class="table" style="font-size: 11px;">
        ...
        <tr>
            ...
            <td class="td2"><s:property value="currencySymbol"/><s:property value="invoiceDetail.marginExcTax"/></td>
        </tr>
        <tr>
            <td class="td1"><xms:localization text="Late Fee:"/></td>
            <td class="td2"><s:property value="currencySymbol"/><s:property value="invoiceDetail.lateFee"/></td>
        </tr>
        <tr>
            <td class="td1"><xms:localization text="Paid Late Fee:"/></td>
            <td class="td2"><s:property value="currencySymbol"/><s:property value="invoiceDetail.paidLateFee"/></td>
        </tr>
    </table>
</div>
