    ...
    <div class="portlet-body b12 b11">
        <div class="portlet-body b22" style="padding: 0px;">
            <ul id="manage-customer-webship-tabs" class="nav nav-tabs responsive">
                <li class="active" style="margin-left: 10px;"><a href="#webship-users-tab"
                                                                 data-toggle="tab"><xms:localization text="Users"/></a>
                </li>
                <li><a href="#webship-carriers-tab" data-toggle="tab" class="tb3"><xms:localization
                        text="Carriers"/></a></li>
                <li><a href="#webship-customer-profile-tab" data-toggle="tab" class="tb3"><xms:localization
                        text="Customer Profile"/></a></li>        
            </ul>
                                    ...
                                    <div class="form-group">
                                        <form id="frmSaveUserSetting">
                                            <table class="s36 b24">
                                                ...
                                                <tr>
                                                    <td><s:hidden
                                                            name="saveManageCustomer.webship.customer.customerCode"
                                                            value="%{customer.customerCode}"/> <s:checkbox
                                                            name="saveManageCustomer.webship.customer.adminFunction"
                                                            value="%{customer.adminFunction}"/></td>
                                                    <td><xms:localization text="Admin Function"/></td>
                                                    <td><s:select
                                                            name="saveManageCustomer.webship.customer.webshipAdminId"
                                                            value="%{customer.webshipAdminId}" list="webshipList"
                                                            listValue="name" listKey="webshipId" cssClass="form-control"
                                                            headerValue="" headerKey="0"/></td>
                                                    <td><xms:localization text="Set Web Freight Admin"/></td>
                                                </tr>
                                            </table>
                                            <p>
                                            ...
                                            <table class="s36 b24">
                                                <tr>
                                                    ...
                                                    <td><s:checkbox id="sv-%{serviceId}-checkbox"
                                                                    name="saveManageCustomer.webship.services[%{#sv.index}].checked"
                                                ...
                                                <s:if test="shipmentTypes!=null && shipmentTypes.size()>0">
                                                    <table class="s36 b25">
                                                        <s:iterator value="shipmentTypes" status="st">
                                                            <tr>
                                                                <td><s:checkbox
                                                                        name="saveManageCustomer.webship.services[%{#sv.index}].shipmentTypes[%{#st.index}].checked"
                                                                        value="%{services[#sv.index].shipmentTypes[#st.index].checked}"
                                                                        onclick="onShipmentTypeCheck('#sv-%{serviceId}',this)"/></td>
                                                                <td><s:property value="shipmentTypeName"/> <s:hidden
                                                                        name="saveManageCustomer.webship.services[%{#sv.index}].shipmentTypes[%{#st.index}].customerCode"
                                                                        value="%{services[#sv.index].shipmentTypes[#st.index].customerCode}"/>
                                                                    <s:hidden
                                                                            name="saveManageCustomer.webship.services[%{#sv.index}].shipmentTypes[%{#st.index}].userType"
                                                                            value="%{services[#sv.index].shipmentTypes[#st.index].userType}"/>
                                                                    <s:hidden
                                                                            name="saveManageCustomer.webship.services[%{#sv.index}].shipmentTypes[%{#st.index}].serviceId"
                                                                            value="%{services[#sv.index].shipmentTypes[#st.index].serviceId}"/>
                                                                    <s:hidden
                                                                            name="saveManageCustomer.webship.services[%{#sv.index}].shipmentTypes[%{#st.index}].shipmentTypeId"
                                                                            value="%{services[#sv.index].shipmentTypes[#st.index].shipmentTypeId}"/></td>
                                                            </tr>
                                                        </s:iterator>
                                                    </table>
                                                </s:if>
                    ...
                    <div class="row">
                        <div class="portlet-body b12 b11">
                            <div class="form-group">
									...
									<s:hidden name="file_path" id="file_path"   value=""/> 
									<s:file  name="userImage"  cssClass="w10"   id="profile_image_upload"/>
