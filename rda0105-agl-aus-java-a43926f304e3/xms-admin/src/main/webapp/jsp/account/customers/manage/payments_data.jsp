        ...
        <div class="col-lg-4">
            <table class="table" style="font-size: 11px;">
                ...
                <tr>
                    ...
                    <td class="td2" data-detail-credit=""></td>
                </tr>
                <tr>
...
<script type="text/javascript">
    function getInvoices(page) {
        ...
        $.post("manage_customers_payments_search_invoices.ix?reqType=json", data, function (res) {
    ...
    function showInvoiceDetail(code) {
        ...
        $.post("manage_customers_payments_get_invoice_detail.ix?reqType=json", data, function (res) {
            if (res.errorCode == "SUCCESS") {
    ...
    function showPayments(code) {
        ...
        $.post("manage_customers_payments_get_payments.ix?reqType=json", data, function (res) {
            if (res.errorCode == "SUCCESS") {
        ...
        $.post("view_edit_invoice_get_invoice_detail.ix?reqType=json", data, function (res) {
            ...
            if (res.errorCode == "SUCCESS") {
                var dialog = $("#invoice_detail_dialog").dialog({
                    ...
                    close: function (e) {
                        $("#invoice_detail_dialog").remove();
                        $("#payments-tab").append("<div id='invoice_detail_dialog' title='<xms:localization text="Invoice"/>'></div>");
                    }
                });
                dialog.html(res.content);
                dialog.dialog("open");
