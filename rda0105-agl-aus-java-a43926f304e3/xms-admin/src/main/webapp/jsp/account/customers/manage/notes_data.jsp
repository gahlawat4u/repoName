...
<div class="row">
    <div class="portlet-body b12 b11">
        ...
        <table class="table mg0">
            ...
            <tr>
                <th class="s42">
                    <form id="customer_notes_form">
                        <s:hidden id="customer_notes_order_field" name="orderField"/>
                        <s:hidden id="customer_notes_order_type" name="orderType"/>
                        <s:hidden id="customer_notes_page" name="page"/>
                        <table class="s36">
                            <tbody>
                            <tr>
                                <td><xms:localization text="Show"/></td>
                                <td><s:select id="customer_notes_page_size" name="pageSize" list="pageSizes"
...
<script type="text/javascript">
    ...
    function searchCustomerNotes() {
        // Reset note id
        noteId = "";
        // Load Note List
        var data = $("#customer_notes_form").serialize();
        data += "&customerCode=" + "<s:property value="customerCode"/>";
        loadingDialog.dialog("open");
        $.post("manage_customers_notes_search.ix?reqType=json", data, function (res) {
    ...
    function loadNote(noteId) {
        var data = {
            "noteId": noteId,
            "customerCode": <s:property value="customerCode"/>
        };
