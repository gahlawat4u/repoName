                ...
                <div class="portlet-body b22" style="padding: 0px;">
                    ...
                    <div id="cust_base_rates_tab_content" class="tab-content responsive">
                        <div id="cust_base_rates_general_tab" class="tab-pane fade in tb2 active">
                            <div class="row">
                                <div class="portlet-body b12 b11">
                                    <s:hidden name="saveManageFranchiseModel.saveFranBaseRate.customerCode"
                                    ...
                                    <table class="s36">
                                        ...
                                        <tr>
                                            ...
                                            <td width="60"><s:textfield id="minimum_base_charge"
                                                                        name="saveManageFranchiseModel.saveFranBaseRate.minimunBaseCharge"
                                                                        value="%{franchise.minimunBaseCharge}"
                                            ...
                                            <s:iterator value="custBaseRates" status="stats">
                                                ...
                                                <div class="form-group base-rate-row"
                                                        ...
                                                        <div class="well well-sm pull-left c33" style="width: 100%">
                                                            ...
                                                            <div class="pull-left c32" data-group="sel-rate-type">
                                                                <s:select data-index="%{#global_index}"
                                                                          name="saveManageFranchiseModel.saveFranBaseRate.customerBaseRates[%{#global_index}].rateType"
                                                            ...
                                                            <div class="pull-left c32" data-group="base-rate">
                                                                <s:if test="zoneCheck == 'false'">
                                                                    <s:textfield data-index="%{#global_index}"
                                                                                 name="saveManageFranchiseModel.saveFranBaseRate.customerBaseRates[%{#global_index}].rate"
                                                                                 value="%{rate}"
                                                        ...
                                                        <ul class="c36" style="width: 14324px; overflow: hidden;">
                                                            <li class="pull-left c35" style="margin-left: 40px;">
                                                                <s:checkbox data-group="zone-check"
                                                                            ...
                                                                            name="saveManageFranchiseModel.saveFranBaseRate.customerBaseRates[%{#global_index}].zoneCheck"
                                                                ...
                                                                <li>
                                                                    <div class="pull-left c34" data-group="zone">
                                                                        <input data-index="<s:property value="#global_index"/>"
                                                                               name="saveManageFranchiseModel.saveFranBaseRate.customerBaseRates[<s:property value="#global_index"/>].customerBaseRateDetails[<s:property value="#dStats.index"/>].zone"
                                                                            ...
                                                                            name="saveManageFranchiseModel.saveFranBaseRate.customerBaseRates[<s:property value="#global_index"/>].customerBaseRateDetails[<s:property value="#dStats.index"/>].rate"
                                                                            <s:if test="zoneCheck == 'false'">disabled="disabled"</s:if>
                                                                            class="form-control alloptions text-center"
                                                    ...
                                                    <div id="hidden-input-<s:property value="shipmentTypeId"/>-<s:property value="content"/>-<s:property value="bound"/>">
                                                        <s:hidden
                                                                name="saveManageFranchiseModel.saveFranBaseRate.customerBaseRates[%{#global_index}].baserateDescription"
                                                                value="%{displayName}" data-index="%{#global_index}"/>
                                                        <s:hidden
                                                                name="saveManageFranchiseModel.saveFranBaseRate.customerBaseRates[%{#global_index}].weight"
                                                                value="%{weight}" data-index="%{#global_index}"/>
                                                        <s:hidden
                                                                name="saveManageFranchiseModel.saveFranBaseRate.customerBaseRates[%{#global_index}].shipmentTypeId"
                                                                value="%{shipmentTypeId}"
                                                                data-index="%{#global_index}"/>
                                                        <s:hidden
                                                                name="saveManageFranchiseModel.saveFranBaseRate.customerBaseRates[%{#global_index}].customerCode"
                                                                value="%{customerCode}" data-index="%{#global_index}"/>
                                                        <s:hidden
                                                                name="saveManageFranchiseModel.saveFranBaseRate.customerBaseRates[%{#global_index}].content"
                                                                value="%{content}" data-index="%{#global_index}"/>
                                                        <s:hidden
                                                                name="saveManageFranchiseModel.saveFranBaseRate.customerBaseRates[%{#global_index}].bound"
                                                                value="%{bound}" data-index="%{#global_index}"/>
                                                        <s:hidden
                                                                name="saveManageFranchiseModel.saveFranBaseRate.customerBaseRates[%{#global_index}].carrierId"
                                            ...
                                            <div class="form-group base-rate-row"
                                                ...
                                                <div class="base-rate">
                                                    <div class="well well-sm pull-left c33" style="width: 100%">
                                                        ...
                                                        <div class="pull-left c32">
                                                            <s:if test="#stats.index == 0">
                                                                <input type="checkbox" value="" style="margin-top: 6px;"
                                                                       class="rate_sheet_check">
                                                            </s:if>
                                                        </div>
                                                        <div class="pull-left c32" data-group="sel-rate-type">
                                                            <s:select data-index="%{#global_index}"
...
<script type="text/javascript">
    ...
    function saveFranchiseBaseRate() {
        var data = $("#frmSaveCustomerBaseRates").serialize();
        doPostDataByParameters("manage_fran_base_rate_save.ix?reqType=json", data, "<xms:localization text="Saved successful!" />", "", true, true);
    }
    ...
    function addWeightBreak($this) {
        ...
        buttons["<xms:localization text="Save" />"] = function () {
            ...
            $.post("add_weight_break_do_add_franchise.ix?reqType=json", dataForm, function (res) {
        ...
        console.log("saveFranBaseRate.customerBaseRates[" + index + "]");
        console.log("saveFranBaseRate.customerBaseRates[" + (index + 1) + "]");
