                                                    ...
                                                    <div class="col-lg-6">
                                                        <table class="table s99" style="margin-bottom: 0px">
                                                            ...
                                                            <tr>
                                                                <td class="td1"><xms:localization
                                                                        text="Destination"/></td>
                                                                <s:if test="detailInfoModel.contentDescription != null">
                                                                    <td class="td2">${detailInfoModel.contentDescription}</td>
                                                                </s:if>
                                                                <s:else>
                                                        ...
                                                        <table class="table s99" style="margin-bottom: 0px">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="td2"><s:if test="trackingModels != null">
                                                                    <s:iterator value="trackingModels" var="">
                                                                        <s:if test="eventDescription == 'Delivered' ">
                                                                            ${trackDate}
                                                                        </s:if>
                                                                    </s:iterator>
                                                                </s:if></td>
