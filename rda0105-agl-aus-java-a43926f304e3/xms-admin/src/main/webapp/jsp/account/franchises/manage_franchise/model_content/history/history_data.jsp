            ...
            <div class="row">
                <div class="portlet-body b12 b11">
                    ...
                    <table class="table mg0">
                        ...
                        <tr>
                            <th class="s42">
                                <form id="franchise_history_form">
                                    <s:hidden id="franchise_history_order_field" name="orderField"/>
                                    <s:hidden id="franchise_history_order_type" name="orderType"/>
                                    <s:hidden id="franchise_history_page" name="page"/>
                                    <table class="s36">
                                        <tbody>
                                        <tr>
                                            <td><xms:localization text="Show"/></td>
                                            <td><s:select id="franchise_history_page_size" name="pageSize"
                                                          list="pageSizes" onchange="onChangePageSize()"/></td>
                    ...
                    <div id="listHistory">
                        <table class="table table-bordered mg0" id="franchise_history_table">
                            <thead>
                            <tr>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#franchise_history_table").tablesorter({
            sortFieldId: "franchise_history_order_field",
            sortTypeId: "franchise_history_order_type",
            fieldList: fieldList,
            callback: doSearch
        });
    });
    ...
    function changePage(page) {
        $("#franchise_history_page").val(page);
        doSearch();
    }

    function onChangePageSize() {
        $("#franchise_history_page").val(1);
        doSearch();
    }

    function doSearch() {
        var data = $("#franchise_history_form").serialize();
        data += "&franchiseCode=" + $("#sel_franchise").val();
        loadingDialog.dialog("open");
        $.post("manage_franchise_history_search.ix?reqType=json", data, function (res) {
