...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#txt_value_search").attr("name", "filterModel.connoteNumber");
    ...
    function viewDetail() {
        ...
        buttons["<xms:localization text="Export Pdf"/>"] = function () {
            exportDetail();
        };
        ...
        var dialog = $("#history_detaill").dialog({
            modal: true,
            autoOpen: false,
            width: "80%",
            buttons: buttons,
            ...
            title: "<xms:localization text="Shipment Detail"/>",
            close: function (event, ui) {
                $(this).html("");
            }
        });

        $.post("history_detail.ix?reqType=json", data, function (res) {
    ...
    <s:if test="historyModels==null || historyModels.totalRecords==0">
    hasRecords = false;
    </s:if>
    <s:else>
    hasRecords = true;
