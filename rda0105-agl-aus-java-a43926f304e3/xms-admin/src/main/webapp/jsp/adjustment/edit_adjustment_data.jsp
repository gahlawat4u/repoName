...
<div class="form-group">
    <form id="frmEditAdjustment" carrier-amount='<s:property value="adjustment.carrierAmount" />'
        ...
        <div class="row">
            <div class="col-lg-6">
                <s:hidden name="adjustment.adjustmentId"/>
                <s:hidden id="adjustment_status" name="adjustment.status"/>
                <table class="table" style="font-size: 11px;" id="adjustment-table">
                    ...
                    <tr>
                        ...
                        <td class="td2 s51" colspan="2"><s:property value="adjustment.adjustmentType"/> <s:hidden
                                id="adjustment_adjustmentType" name="adjustment.adjustmentType"/></td>
                    </tr>
                    <tr data-group="carrier-amount">
                        <td class="td1"><xms:localization text="Carrier Amount:"/><span class="s30"> *</span></td>
                        <td class="td2" colspan="2"><input onkeyup="validCarrierAmount()" numeric-text="true"
                                                           name="adjustment.carrierAmount"
                                                           class="form-control alloptions" type="text" maxlength="25"
                                                           value="<s:property value="adjustment.carrierAmount" />"
                                                           <s:if test="adjustment.adjustmentType == 'Full Refund'">disabled</s:if> />
                            <s:hidden name="adjustmentInfo.carrierAmount"/> <span class="s30"
                    ...
                    <tr data-group="franchise-amount">
                        ...
                        <td class="td2" colspan="2"><input onkeyup="validFranchiseAmount()" numeric-text="true"
                                                           name="adjustment.franchiseAmount"
                                                           class="form-control alloptions" type="text" maxlength="25"
                                                           value="<s:property value="adjustment.franchiseAmount" />"
                                                           <s:if test="adjustment.adjustmentType == 'Full Refund' || adjustment.status == 4">disabled</s:if> />
                            <s:hidden name="adjustmentInfo.franchiseAmount"/> <span class="s30"
                                                                                    id="msg_franchise_amount"></span>
                        </td>
                    </tr>
                    <tr data-group="franchise-amount">
                    ...
                    <tr data-group="customer-amount">
                        ...
                        <td class="td2" colspan="2"><input onkeyup="validCustomerAmount()" numeric-text="true"
                                                           ...
                                                           <s:if test="adjustment.adjustmentType == 'Full Refund'">disabled</s:if>/>
                            <s:hidden name="adjustmentInfo.customerAmount"/> <span class="s30"
                                                                                   id="msg_customer_amount"></span></td>
                    </tr>
                    <tr data-group="customer-amount">
                ...
                <table class="table" style="font-size: 11px;">
                    ...
                    <tr>
                        ...
                        <td class="td2" colspan="2"><s:if test="adjustment.status==5">
                            <s:i18n_select id="adjustment_creditType" name="adjustment.creditType" list="creditTypes"
                                           listKey="id" listValue="name" onchange="onCreditTypeChange()"/>
                        </s:if> <s:else>
                            <s:property value="adjustment.creditTypeName"/>
                        </s:else> <s:hidden id="adjustment_creditType" name="adjustment.creditType"/></td>
                    </tr>
                    <tr>
...
//        $("input[name='adjustment.gstCarrierAmount']").val(gstCarrierAmount);
    ...
    function validCustomerAmount() {
        var creditType = $("#adjustment_creditType").val();
    ...
    function showHideAmount(userLevel) {
        var adjustmentType = $("#adjustment_adjustmentType").val();
        var status = $("#adjustment_status").val();
        var creditType = $("#adjustment_creditType").val();
        if (userLevel > 3) {
