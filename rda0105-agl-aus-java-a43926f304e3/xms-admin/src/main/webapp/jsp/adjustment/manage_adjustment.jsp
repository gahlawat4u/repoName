...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <ol class="breadcrumb page-breadcrumb pull-left" style="padding-top: 0px;">
        ...
        <li class="hidden"><a href="#"><xms:localization text="Manage Adjustments"/></a>&nbsp;&nbsp;<i
                class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
        <li class="active"><xms:localization text="Manage Adjustments"/></li>
    </ol>
                    ...
                    <div class="col-lg-12">
                        <div class="portlet box">
                            <div class="portlet-header">
                                <div class="caption">
                                    <xms:localization text="Manage Adjustments"/>
                                </div>
                                <div class="col-lg-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5">
                                                    <table class="table" style="font-size: 11px;">
                                                        ...
                                                        <tr>
                                                            <td class="td1"><xms:localization
                                                                    text="Credit Number:"/></td>
                                                            <td class="td2"><s:textfield name="filter.creditCode"
                                                                                         cssClass="form-control alloptions"
                                                                                         maxlength="25"/></td>
                                                        </tr>
                                                        <tr>
...
<script>
    ...
    function updateAdjustment(obj) {
        ...
        $.post("update_adjustment.ix?reqType=json", data, function (res) {
    ...
    function doSearch() {
        ...
        $.post("search_adjustment.ix?reqType=json", data, function (res) {
    ...
    function showNoteAdjDlg(id, type) {
        ...
        loadingDialog.dialog("open");
        $.post("load_adjustment_note.ix?reqType=json", data, function (res) {
            loadingDialog.dialog("close");
            if (res.errorCode == "SUCCESS") {
    ...
    function makeAdjNote(type, obj) {
        ...
        $.post("make_adjustment_note.ix?reqType=json", data, function (res) {
            if (res.errorCode == "SUCCESS") {
                $(obj).dialog("close");
                $("#filter_page").val($("#current_page").val());
                doSearch();
    ...
    function editAdj(id) {
        var data = "adjustmentId=" + id;
        loadingDialog.dialog("open");
        $.post("show_adjustment.ix?reqType=json", data, function (res) {
            loadingDialog.dialog("close");
            if (res.errorCode == "SUCCESS") {
    ...
    function updateSubStatus(id) {
        var data = "adjustmentId=" + id;
        loadingDialog.dialog("open");
        $.post("update_adjustment_sub_status.ix?reqType=json", data, function (res) {
            loadingDialog.dialog("close");
            if (res.errorCode == "SUCCESS") {
                $("#filter_page").val($("#current_page").val());
                doSearch();
                //messageDialog.html("Status updated successfull.");
                //messageDialog.dialog("open");
            } else {
                alertDialog.html(res.errorMsg);
                alertDialog.dialog("open");
    ...
    function resubmit(id) {
        ...
        $.post("resubmit_adjustment.ix?reqType=json", data, function (res) {
            ...
            if (res.errorCode == "SUCCESS") {
                $("#filter_page").val($("#current_page").val());
                doSearch();
                messageDialog.html("<xms:localization text="Updated successfull." />");
                messageDialog.dialog("open");
            } else {
                alertDialog.html(res.errorMsg);
                alertDialog.dialog("open");
    ...
    function exportClick(option) {
        ...
        switch (option) {
            ...
            case 'html':
                ...
                var data = $("#frmSearchAdjustment").serialize();
                $.post("manage_adjustment_do_print.ix", data, function (res) {
                    loadingDialog.dialog("close");
            ...
            case 'xls':
                ...
                var pageSize = $("select#filter_pageSize option:selected").val();
                data = data + "&filter.pageSize=" + pageSize;
                $.fileDownload("manage_adjustment_do_export.ix", {
