                            ...
                            <div class="portlet-body" style="padding: 0px;">
                                <div class="tab-content responsive">
                                    <div id="Overview-tab" class="tab-pane fade in active">
                                        <form id="adjustment_request_form">
                                            <s:hidden name="adjustmentRequest.airbillNumber"/>
                                            <s:hidden name="adjustmentRequest.shipmentId"/>
                                            <s:hidden name="adjustmentRequest.invoiceCode"/>
                                        </form>
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <table class="table" style="font-size: 11px;" id="adjustment-table">
                                                        ...
                                                        <tr data-group="carrier-amount">
                                                            <td class="td1"><xms:localization
                                                                    text="Carrier Amount :"/><span class="s30"> *</span>
                                                            </td>
                                                            <td class="td2" colspan="2"><input numeric-text="true"
                                                                                               name="adjustmentRequest.carrierAmount"
                                                                                               class="form-control alloptions"
                                                                                               type="text"
                                                                                               maxlength="25" value="0"
                                                                                               onkeyup="validCarrierAmount()"/>
                                                                <s:hidden name="adjustmentInfo.carrierAmount"/> <span
                                                        ...
                                                        <tr data-group="carrier-amount">
                                                            ...
                                                            <td class="td2 s51" colspan="2"><input class="disable-input"
                                                                                                   ...
                                                                                                   maxlength="25"
                                                                                                   value="0"/> <s:hidden
                                                                    name="adjustmentInfo.gstCarrierAmount"/></td>
                                                        </tr>
                                                        <tr data-group="franchise-amount">
                                                            <td class="td1"><xms:localization
                                                                    text="Franchise Amount :"/><span
                                                                    class="s30"> *</span></td>
                                                            <td class="td2" colspan="2"><input numeric-text="true"
                                                                                               ...
                                                                                               type="text"
                                                                                               maxlength="25" value="0"
                                                                                               onkeyup="validFranchiseAmount()"/>
                                                                <s:hidden name="adjustmentInfo.franchiseAmount"/><span
                                                                        class="s30" id="msg_franchise_amount"></span>
                                                            </td>
                                                        </tr>
                                                        <tr data-group="franchise-amount">
                                                            <td class="td1"><xms:localization
                                                        ...
                                                        <tr data-group="customer-amount">
                                                            <td class="td1"><xms:localization text="Customer Amount :"/><span
                                                                    class="s30"> *</span></td>
                                                            <td class="td2" colspan="2"><input numeric-text="true"
                                                                                               ...
                                                                                               onkeyup="validCustomerAmount()"/>
                                                                <s:hidden name="adjustmentInfo.customerAmount"/><span
                                                                        class="s30" id="msg_customer_amount"></span>
                                                            </td>
                                                        </tr>
                                                        <tr data-group="customer-amount">
                                                            <td class="td1"><xms:localization
...
<script>
    ...
    function changeCreditType() {
        ...
        var adjustType = $("select#adjustmentRequest_adjustType option:selected").val();
        var adjustmentType = $("select#adjustmentRequest_adjustmentType option:selected").val();
        var data = $("#adjustment_request_form").serialize();
        console.log(data);
        data += "&adjustmentRequest.creditType=" + creditType;
        data += "&adjustmentRequest.adjustType=" + adjustType;
        data += "&adjustmentRequest.adjustmentType=" + adjustmentType;
        $.post("adjustment_do_adjust.ix?reqType=json", data, function (res) {
    ...
    function changeAdjustType(type) {
        var creditType = $("#adjustmentRequest_creditType option:selected").val();
        var adjustType = $("select#adjustmentRequest_adjustType option:selected").val();
        var adjustmentType = $("select#adjustmentRequest_adjustmentType option:selected").val();
        var data = $("#adjustment_request_form").serialize();
    ...
    function buildJSONRequest() {
        ...
        $("#adjustment_request_list tr").each(function () {
            ...
            item["adjustmentType"] = encodeURIComponent(adjustmentType);
    ...
    function recalculateAmount() {
        ...
        <xms:localization text='Close' />": function (){
         ...
         messageDialog.html("
        <xms:localization text='You cannot continue adjust this airbill because it has been adjusting all possible values.' />");
    ...
    function validInput() {
        ...
        if ($("#adjustmentRequest_creditType").val() != 2) {
            if (carrierAmount < 0) {
            ...
            if (franchiseAmount > valid_fran_amount && valid_fran_amount > 0) {
            ...
            if (customerAmount > valid_cust_amount && valid_cust_amount > 0) {
            ...
            var aglWarrantyLimit = '<s:property value="remainAglWarranty" />';
            if (customerAmount > aglWarrantyLimit) {
                alertDialog.html('<xms:localization text="The customer amount cannot be greater than " />' + aglWarrantyLimit);
                alertDialog.dialog("open");
                return false;
            }
        }
...
//        $("input[name='adjustmentRequest.gstCarrierAmount']").val(gstCarrierAmount);
    ...
    function sendAdjustmentRequest() {
        ...
        if ($("#adjustment_request_list tr#adjustment_request_list_header").length != 0) {
            ...
            $.post("save_adjustment_requests.ix?reqType=json", data, function (res) {
    ...
    function showHideAmount(userLevel) {
        var creditType = $("#adjustmentRequest_creditType option:selected").val();
        var adjustmentType = $("select[name='adjustmentRequest.adjustmentType'] option:selected").val();
        if (userLevel > 3) {
            $("table#adjustment-table tr[data-group='carrier-amount']").hide();
        } else {
            $("table#adjustment-table tr[data-group='carrier-amount']").show();
        }
        if (creditType == 1 || creditType == 2) {
            $("input[name='adjustmentRequest.carrierAmount']").val("0.00");
            $("input[name='adjustmentRequest.gstCarrierAmount']").val("0.00");
            $("input[name='adjustmentRequest.carrierAmount']").attr("readonly", true);
            $("input[name='adjustmentRequest.franchiseAmount']").val("0.00");
            $("input[name='adjustmentRequest.gstFranchiseAmount']").val("0.00");
            $("input[name='adjustmentRequest.franchiseAmount']").attr("readonly", true);
            if (creditType == 2) {
                $("input[name='adjustmentRequest.gstCustomerAmount']").val("0.00");
            }
        } else {
        ...
        if (adjustmentType == "Full Refund") {
            ...
            $("input[name='adjustmentRequest.customerAmount']").val($("#adjustmentInfo_customerAmount").val());
            $("input[name='adjustmentRequest.gstCustomerAmount']").val($("#adjustmentInfo_gstCustomerAmount").val());
            $("input[name='adjustmentRequest.customerAmount']").attr("readonly", true);
        }
    }
