...
<table class="s32 table table-striped table-bordered tablesorter" border="0" id="quick_search_booking_no_table">
    <thead>
    <tr>
    ...
    <s:else>
        <s:iterator value="qsShipmentByConfirmationNo.records">
            <tr>
                <td align="left" style="cursor: pointer" onclick="get_data('<s:property value="customerCode"/>',7)">
