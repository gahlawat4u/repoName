...
<table class="s32 table table-striped table-bordered tablesorter" border="0" id="quick_search_reference_table">
    <thead>
    <tr>
    ...
    <s:else>
        <s:iterator value="qsShipmentByReference.records">
            <tr>
                <td align="left" style="cursor: pointer" onclick="get_data('<s:property value="customerCode"/>',6)">
