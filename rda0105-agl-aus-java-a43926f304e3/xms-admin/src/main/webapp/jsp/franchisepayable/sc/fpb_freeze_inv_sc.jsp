    ...
    <div id="page-wrapper">
        ...
        <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
            <ol class="breadcrumb page-breadcrumb pull-left"
                ...
                <li class="hidden"><a href="#"><xms:localization text="Freeze Franchise Receivables"/></a>&nbsp;&nbsp;<i
                        class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                <li class="active"><xms:localization text="Freeze Franchise Receivables"/></li>
            </ol>
                                                    ...
                                                    <div class="col-lg-12" style="height: 500px;">
                                                        ...
                                                        <table class="s36">
                                                            <tr>
                                                                ...
                                                                </select> <input name="startDate" id="startDate"
                                                                                 type="hidden"/>
...
<script type="text/javascript">
    ...
    function doFreeze() {
        ...
        postJsonByPramametersWithMessage('fpb_freeze_inv_sc.ix?reqType=json', {
            'startDate': startDate,
            'endDate': endDate
        }, 'loading', 'payableSelDaterange', "<xms:localization text="Frozen successfully." />");
    }
</script>
