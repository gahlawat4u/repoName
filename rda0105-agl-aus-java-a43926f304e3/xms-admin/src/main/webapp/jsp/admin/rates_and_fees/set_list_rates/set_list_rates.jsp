...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <ol class="breadcrumb page-breadcrumb pull-left" style="padding-top: 0px;">
        ...
        <li class="hidden"><a href="#"><xms:localization text="Set List Rates (Non Carrier Cost Rate Sheet)"/></a>&nbsp;&nbsp;<i
                class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
        <li class="active"><xms:localization text="Set List Rates (Non Carrier Cost Rate Sheet)"/></li>
    </ol>
                    ...
                    <div class="col-lg-12">
                        <div class="portlet box">
                            <div class="portlet-header">
                                <div class="caption">
                                    <xms:localization text="Set List Rates (Non Carrier Cost Rate Sheet)"/>
                                </div>
                            </div>
...
<script type="text/javascript">
    function saveSheet(shipmentTypeId, content, bound, isPerWeight) {
        ...
        alert("sheetId  "+sheetTd);
        doPostDataByParameters("set_list_rates_set.ix?reqType=json", data, "<xms:localization text="Set Successfully!"/>", sheetTd, true, true);
    }
    function search() {
        var data = $("#search-filter input").serialize();
        doPostDataByParameters("set_list_rates_search.ix?reqType=json", data, "", "table-list-rates", false);
    }
