...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <ol class="breadcrumb page-breadcrumb pull-left"
        ...
        <li class="hidden"><a href="#"><xms:localization
                text="Territory"/></a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
        <li class="active"><xms:localization text="Territory"/></li>
    </ol>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div id="territory-list">
                                                    ...
                                                    <table class="table table-bordered mg0"
                                                        ...
                                                        <s:else>
                                                            <s:iterator value="territories.records">
                                                                <tr
                                                                        data-territoryId="<s:property value="territoryId" />">
                                                    ...
                                                    <div class="dataTables_paginate">
														...
														<span> <s:iterator value="territories.pageRange"
                                                                           status="count">
                                                            <s:if
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 text-right">
                                                <button id="add-carriers-link" class="btn s37"
                                                        onclick="javascript:addTerritory();" type="button">
                                                    New Territory
                                                </button>
                                                <button class="btn s37" type="button"
                                                        onclick="javascript:deleteTerritory();">Delete
                                                    Territory
                                                </button>
...
<script type="text/javascript">
    ...
    function addTerritory() {
        ...
        loadDialog("territory_add.ix?reqType=json", data, "territory_add_form", "Add", "Cancel", "add_territory_dialog", "Add Territory", "territory-list");
    }
