...
<s:form id="admin_supply_edit" method="post" enctype="multipart/form-data">
    <div class="form-actions pal pdt10">
        <div class="row">
            <div class="col-lg-12 text-right">
                <div id="edit-supply" title="Edit Supply">
                    <input type="hidden" name="isEditSupply" value="1"/>
                    ...
                    <div class="form-group">
                        ...
                        <s:textfield name="supply.supplyName" class="form-control" maxlength="25"></s:textfield>
                    </div>
                    <div class="form-group">
                        <p class="text-left">
