    ...
    <div id="page-wrapper">
        ...
        <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
            <ol class="breadcrumb page-breadcrumb pull-left" style="padding-top: 0px;">
                ...
                <li class="hidden"><a href="#"><xms:localization text="UnFreeze Credit Notes"/></a>&nbsp;&nbsp;<i
                        class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                <li class="active"><xms:localization text="UnFreeze Credit Notes"/></li>
            </ol>
                            ...
                            <div class="col-lg-12">
                                <div class="portlet box">
                                    <div class="portlet-header">
                                        <div class="caption">
                                            <xms:localization text="UnFreeze Credit Notes"/>
                                        </div>
                                    </div>
                                            ...
                                            <div id="Overview-tab" class="tab-pane fade in active">
                                                <div class="row">
                                                    <div class="col-lg-12" style="height: 500px;">
                                                        <p>
                                                            <xms:localization
                                                                    text="<b>Note:</b> </br> - To freeze all credit notes for a date, select a date and Franchise the below drop-down.</br> </br>"/>
                                                        ...
                                                        <table class="s36">
                                                            <tr>
                                                                ...
                                                                <td><a class="btn s37"
                                                                    ...
                                                                    <xms:localization
                                                                            text="UnFreeze Credit Notes for this Date"/>
                                                                </a></td>
                                                            </tr>
                                                        </table>
                                                        </s:form>
                                                        </br>
                                                        <s:form id="unfreeze-by-credit-note-code">
                                                            <table class="s36">
                                                                <tr>
                                                                    ...
                                                                    <td><a class="btn s37"
                                                                           onclick="doUnfreezeByCreditNoteCode()">
                                                                        <xms:localization
                                                                                text="UnFreeze this Credit Note"/>
                                                                    </a></td>
                                                                </tr>
                                                            </table>
                                                        </s:form>
...
<script type="text/javascript">
    function changeFranchiseCode(franchiseCode) {
        ...
        doPostDataByParameters("unfreeze_send_credit_notes_change_franchise_code.ix?reqType=json", data, "", "sel-date-list");
    }

    function doFreezeCreditNoteByFranchiseCodeData() {
        var data = $("#send-credit-by-franchise-code-date").serialize();
        doPostDataByParameters("do_unfreeze_credit_notes.ix?reqType=json", data, "UnFreeze successful!", "sel-date-list");
    }

    function doUnfreezeByCreditNoteCode() {
        var data = $("#unfreeze-by-credit-note-code").serialize();
        doPostDataByParameters("do_unfreeze_by_credit_note_code.ix?reqType=json", data, "UnFreeze successful!", "sel-date-list");
    }
