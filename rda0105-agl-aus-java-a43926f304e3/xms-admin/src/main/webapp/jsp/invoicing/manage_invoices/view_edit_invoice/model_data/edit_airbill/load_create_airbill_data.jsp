                ...
                <div class="col-lg-4">
                    <table class="table" style="font-size: 11px;">
                        ...
                        <tr>
                            ...
                            <td class="td2" id="td_shipment_type_new_airbill"><s:select list="shipmentTypeModels"
                                                                                        listKey="serviceCode"
                        ...
                        <table class="table" style="font-size: 11px;">
                            <s:iterator value="accessorialInfoModels" status="accessorialInfo">
                                <tr class="tr_accessorial_<s:property value='%{#accessorialInfo.index+1}'/>">
                                    ...
                                    <td class="td2" id="td_accessorial_new_airbil_${accessorialInfo.index}" colspan="7"
                                ...
                                <s:else>
                                    ...
                                    <tr class="tr_accessorial_<s:property value='%{#accessorialInfo.index+1}'/> tr_gst_status">
                                        ...
                                        <td class="td1"><xms:localization text="Tax Amount"/></td>
                                        <td class="td2"><s:textfield readonly="true" cssClass="form-control alloptions"
                                                                     name="accessorialInfoModels[%{#accessorialInfo.index}].customerTaxAmount"/></td>
                                    </tr>
                                </s:else>
...
<script type="text/javascript">
    ...
    function changeService(val) {
        ...
        getServiceLevelAndAccessorials(action, data, "", "td_shipment_type_new_airbill", true, false, action2, "td_accessorial_new_airbil");
    }
