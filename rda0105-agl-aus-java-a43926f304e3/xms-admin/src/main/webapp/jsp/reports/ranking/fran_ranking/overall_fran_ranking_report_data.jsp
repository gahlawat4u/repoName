...
<table id="overall-fran-ranking-table" class="table table-bordered mg0 table-hover">
    <thead>
    <tr>
    ...
    <s:else>
        <s:iterator value="rankingReport.records">
            <tr>
                ...
                <td class="text-right" data-group="inc-gst"><s:property value="currencySymbol"/> <s:property
                        value="revenueIncGst"/></td>
                <td class="text-right" data-group="exc-gst"><s:property value="currencySymbol"/> <s:property
                        value="revenueExcGst"/></td>
                <td class="text-right" data-group="inc-gst"><s:property value="currencySymbol"/> <s:property
                        value="revenuePerShipIncGst"/></td>
                <td class="text-right" data-group="exc-gst"><s:property value="currencySymbol"/> <s:property
                        value="revenuePerShipExcGst"/></td>
                <td class="text-right" data-group="inc-gst"><s:property value="currencySymbol"/> <s:property
                        value="franchiseCostIncGst"/></td>
                <td class="text-right" data-group="exc-gst"><s:property value="currencySymbol"/> <s:property
                        value="franchiseCostExcGst"/></td>
                <td class="text-right" data-group="inc-gst"><s:property value="currencySymbol"/> <s:property
                        value="marginIncGst"/></td>
                <td class="text-right" data-group="exc-gst"><s:property value="currencySymbol"/> <s:property
                        value="marginExcGst"/></td>
                <td class="text-right" data-group="inc-gst"><s:property value="currencySymbol"/> <s:property
                        value="marginPerShipIncGst"/></td>
                <td class="text-right" data-group="exc-gst"><s:property value="currencySymbol"/> <s:property
                        value="marginPerShipExcGst"/></td>
                <td class="text-right" data-group="inc-gst"><s:property value="currencySymbol"/> <s:property
                        value="marginPerWeightIncGst"/></td>
                <td class="text-right" data-group="exc-gst"><s:property value="currencySymbol"/> <s:property
                        value="marginPerWeightExcGst"/></td>
            </tr>
        </s:iterator>
    </s:else>
    </tbody>
...
<script type="text/javascript">
    $(document).ready(
            function () {
                $("#overall-fran-ranking-table").tablesorter(
                        {
                            sortFieldId: "orderField",
                            sortTypeId: "orderType",
                            fieldList: ["rank", "franchise_code", "territory", "activate_customers", "activations", "shipments", "weights", "rev_inc_gst", "rev_exc_gst", "rev_per_ship_inc_gst", "rev_per_ship_exc_gst", "fran_cost_inc_tax", "fran_cost_exc_tax", "gross_margin_inc_tax",
                                "gross_margin_exc_tax", "margin_per_ship_inc_tax", "margin_per_ship_exc_tax", "margin_per_weight_inc_tax", "margin_per_weight_exc_tax"],
                            callback: doReport
                        });
                showColumns();
            });
