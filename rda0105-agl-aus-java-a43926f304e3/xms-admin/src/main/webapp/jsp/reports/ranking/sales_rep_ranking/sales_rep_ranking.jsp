...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <ol class="breadcrumb page-breadcrumb pull-left" style="padding-top: 0px;">
        ...
        <li class="hidden"><a href="#"><xms:localization text="Sales Rep Rankings"/></a>&nbsp;&nbsp;<i
                class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
        <li class="active"><xms:localization text="Sales Rep Rankings"/></li>
    </ol>
                    ...
                    <div class="col-lg-12">
                        <div class="portlet box">
                            <div class="portlet-header">
                                <div class="caption">
                                    <xms:localization text="Sales Rep Rankings"/>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 ">
                                                <div class="form-group ">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div id="customDateRange" style="display: none;">
                                                                    <form id="sales-rep-ranking-report-form">
                                                                        <table>
                                                                            <tr>
                                                                                <td><xms:localization
                                                                                        text="Start"/></td>
                                                    ...
                                                    <table class="s36 b24">
                                                        <tr>
                                                            <td><input id="excludeGst" type="checkbox"
                                                                       onclick="showColumns()"/>
                                                                <s:hidden id="excludeGST"/></td>
                                                ...
                                                <div id="sales-rep-ranking-report">
                                                    ...
                                                    <table id="sales-rep-ranking-table"
                                                        ...
                                                        <s:if test="rankingReport==null || rankingReport.totalRecords==0">
                                                            <tr>
                                                                <td colspan="20"><xms:localization
                                                        ...
                                                        <s:else>
                                                            ...
                                                            <tr>
                                                                <th colspan="20"><xms:localization text="Showing"/>
...
<script type="text/javascript">
    ...
    function onPeriodTypeChange() {
        ...
        if (periodType == 3) {
            ...
            $.post("sales_rep_ranking_date_range.ix?reqType=json", "periodType=" + periodType, function (res) {
    ...
    function doReport() {
        var data = $("#sales-rep-ranking-report-form").serialize();
        data += "&franchiseCode=" + $("#franchiseCode option:selected").val();
        ...
        loadingDialog.dialog("open");
        $.post("sales_rep_ranking_do_report.ix?reqType=json", data, function (res) {
            loadingDialog.dialog("close");
            if (res.errorCode == "SUCCESS") {
                $("#sales-rep-ranking-report").html(res.content);
                $("#btn-export").show();
    ...
    function showColumns() {
        ...
        if (excludeGst) {
            $("#sales-rep-ranking-table th[data-group='inc-gst']").hide();
            $("#sales-rep-ranking-table td[data-group='inc-gst']").hide();
            $("#sales-rep-ranking-table th[data-group='exc-gst']").show();
            $("#sales-rep-ranking-table td[data-group='exc-gst']").show();
            $("#excludeGST").val("true")
        } else {
            $("#sales-rep-ranking-table th[data-group='inc-gst']").show();
            $("#sales-rep-ranking-table td[data-group='inc-gst']").show();
            $("#sales-rep-ranking-table th[data-group='exc-gst']").hide();
            $("#sales-rep-ranking-table td[data-group='exc-gst']").hide();
    ...
    function exportClick(option) {
        ...
        switch (option) {
            ...
            case 'html':
                ...
                $.post("sales_rep_ranking_print.ix", data, function (res) {
                    loadingDialog.dialog("close");
            ...
            case 'xls':
                ...
                loadingDialog.dialog("open");
                $.fileDownload("sales_rep_ranking_export.ix", {
