(function ($) {
        ...
        jstablesorter: new function () {
            ...
            this.construct = function (settings) {
                return this.each(function () {
                    ...
                    this.config = {};
                    config = $.extend(this.config, $.jstablesorter.defaults, settings);
                    $this = $(this);
                    $.data(this, "jstablesorter", config);
    ...
    $.fn.extend({
        jstablesorter: $.jstablesorter.construct
    });
    var ts = $.jstablesorter;
    ts.addParser({
        id: "text",
        is: function (s) {
            return true;
    ...
    ts.addParser({
        ...
        is: function (s, table) {
            var c = table.config;
            return $.jstablesorter.isDigit(s, c);
        },
        format: function (s) {
            return $.jstablesorter.formatFloat(s);
        },
        type: "numeric"
    });
    ts.addParser({
        ...
        format: function (s) {
            return $.jstablesorter.formatFloat(s.replace(new RegExp(/[£$€]/g), ""));
        },
        type: "numeric"
    });
    ts.addParser({
        ...
        format: function (s) {
            ...
            return $.jstablesorter.formatFloat(r);
        },
        type: "numeric"
    });
    ts.addParser({
    ...
    ts.addParser({
        ...
        format: function (s) {
            return $.jstablesorter.formatFloat((s != "") ? new Date(s.replace(new RegExp(/-/g), "/")).getTime() : "0");
        },
        type: "numeric"
    });
    ts.addParser({
    ...
    ts.addParser({
        ...
        format: function (s) {
            return $.jstablesorter.formatFloat(new Date(s).getTime());
        },
        type: "numeric"
    });
    ts.addParser({
    ...
    ts.addParser({
        ...
        format: function (s) {
            return $.jstablesorter.formatFloat(new Date("2000/01/01 " + s).getTime());
        },
        type: "numeric"
    });
    ts.addParser({
    ...
    ts.addWidget({
        ...
        format: function (table) {
            ...
            if (table.config.debug) {
                $.jstablesorter.benchmark("Applying Zebra widget", time);
            }
        }
    });
})(jQuery);
