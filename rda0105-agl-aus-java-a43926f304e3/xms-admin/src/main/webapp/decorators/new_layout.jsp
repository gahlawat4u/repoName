<%@page import="com.gms.xms.cache.SystemSettingCache" %>
<%@page import="com.gms.xms.common.constants.AppConstants" %>
<%@page import="com.gms.xms.common.constants.Attributes" %>
<%@page import="com.gms.xms.persistence.service.admin.MenuServiceImp" %>
<%@page import="com.gms.xms.txndb.vo.admin.MenuVo" %>
...
<div id="loading-dialog" title="<xms:localization text="Loading..." />">
    <div class="cs22">
        ...
        <span><strong><xms:localization text="Please wait ..."/></strong></span>
    </div>
</div>
        ...
        <nav id="topbar" role="navigation" style="margin-bottom: 0;" data-step="3"
            ...
            <div class="navbar navbar-default" role="navigation">
                ...
                <div class="navbar-collapse collapse"
                    ...
                    <%
                        String stgMenuEnable = SystemSettingCache.getInstance().getValueByKey("XMS 2.0 Live Menu");
                        if ("Y".equalsIgnoreCase(stgMenuEnable)) {
                    %>
                    <!-- BEGIN MENU -->
                    <ul class="nav navbar-nav">
                        <%
                            String adminLevel = null;
                            Integer adminCollector = null;
                            try {
                                adminLevel = (String) request.getSession().getAttribute("SESS_XMS_ADMIN_LEVEL");
                                adminCollector = (Integer) request.getSession().getAttribute("SESS_XMS_ADMIN_COLLECTOR");
                            } catch (Exception e) {
                            }

                            if (adminLevel != null) {
                                MenuServiceImp menuServiceImp = new MenuServiceImp();
                                List<MenuVo> menuVos = menuServiceImp.prepareMenu(adminCollector,
                                        Double.valueOf(adminLevel).longValue(), adminLevel, 0);
                                String phpContext = SystemSettingCache.getInstance().getValueByKey("XMS 1.0 URL");
                                phpContext = StringUtils.isBlank(phpContext) ? "http://no_config/" : phpContext;
                                String lang;
                                if (request.getSession() == null) {
                                    lang = AppConstants.DEFAULT_LANG;
                                }
                                Object objLang = request.getSession().getAttribute(Attributes.XMS_LANG);
                                lang = (objLang == null) ? AppConstants.DEFAULT_LANG : (String) objLang;
                        %>
                        <%=WebUtils.genAllMenu(menuVos, WebUtils.getContextPathURL(request), phpContext, lang)%>
                        <%
                            }
                        %>
                    </ul>
                    ...
                    %>
                    <ul class="nav navbar-nav">
                        <li><a href="#" class="st"><i class="fa fa-key fa-fw"></i><span><xms:localization
                                text="ACCOUNT"/></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="#"><xms:localization text="Contacts"/><span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>manage_contact.ix"><span
                                                ...
                                                class="fa fa-external-link fa-fw sws pst"></i></span></a></li>
                                    </ul>
                                </li>
                                <li><a href="#"><xms:localization text="Customers"/><span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>manage_customers.ix"><span
                                                ...
                                                class="fa fa-external-link fa-fw sws pst"></i></span></a></li>
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>search_customers.ix"><span
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>customer_list.ix"><span
                                ...
                                <li><a href="#"><xms:localization text="Franchise"/><span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>manage_franchise.ix"><span
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>franchise_list.ix"><span
                                ...
                                <li><a href="#"><xms:localization text="Users"/><span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>manage_users.ix"><span
                        ...
                        <%-- <li><a href="#" class="st"><i class="fa fa-building-o fa-fw"></i><span> <xms:localization
                                text="INVOICING"/></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="#"><xms:localization text="Invoice Editing Tools"/><span
                                        class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li>
                                ...
                                <li><a href="#"><xms:localization text="Price Validation Tools"/><span
                                        class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>cost_deviations.ix"><span
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>airbill_margins.ix"><span
                                ...
                                <li><a href="#"><xms:localization text="Manage Invoices"/><span
                                        class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>view_edit_invoice.ix"><span
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>credit_notes.ix"><span
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>statements.ix"><span
                                ...
                                <li><a href="#"><xms:localization text="Printing Tools"/><span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>freeze_inv.ix"><span
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>send_credit_notes.ix"><span
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>csv_invoices.ix"><span
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>unfreeze_inv.ix"><span
                                                class="sws"><xms:localization text="Unfreeze Customer Invoices"/></span><span
                                                class="sws mgl"><i class="fa fa-external-link fa-fw sws pst"
                                ...
                                <li><a href="<%=WebUtils.getContextPathURL(request)%>manage_adjustment.ix"><span
                        ...
                        <li><a href="#" class="st"><i class=" fa fa-cubes fa-fw"></i><span> <xms:localization
                                text="RECEIVABLES"/></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="#"><span><xms:localization text="Customers"/></span><span
                                        class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>receive_payment.ix"><span
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>bank_list.ix"><span
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>customer_aging.ix"><span
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>search_payments.ix"><span
                                                class="sws"><xms:localization
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>reminder_letter.ix"><span
                        ...
                        <li><a href="#" class="st"><i class="fa fa-cube fa-fw"></i><span> <xms:localization
                                text="PAYABLES"/></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="#"><span><xms:localization text="Franchise"/></span><span
                                        class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>fpb_ms.ix"><span
                                                class="sws"><xms:localization text="Franchise Payables Details"/></span><span
                                                class="sws mgl"><i class="fa fa-external-link fa-fw sws pst"
                                                                   onclick="window.open('<%=WebUtils.getContextPathURL(request)%>fpb_ms.ix');return false;"></i></span></a>
                                        </li>
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>fpb_freeze_inv_ms.ix"><span
                                                class="sws"><xms:localization
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>fpb_send_inv_ms.ix"><span
                                                class="sws"><xms:localization
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>fpb_inv_ms.ix"><span
                                                class="sws"><xms:localization text="Franchise Payables Invoice"/></span><span
                                                class="sws mgl"><i class="fa fa-external-link fa-fw sws pst"
                                                                   onclick="window.open('<%=WebUtils.getContextPathURL(request)%>fpb_inv_ms.ix');return false;"></i></span></a>
                                        </li>
                                    </ul>
                                </li>
                                <li><a href="#"><xms:localization text="Sales Rep"/><span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li>
                        ...
                        <li><a href="#" class="st"><i class="fa fa-file-text-o fa-fw"></i><span> <xms:localization
                                text="REPORTS"/></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="#"><span><xms:localization text="Customer"/></span><span
                                        class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>customer_status.ix"><span
                                                class="sws"><xms:localization
                                                text="Customer Status Report"/></span><span class="sws mgl"><i
                                                class="fa fa-external-link fa-fw sws pst"
                                                onclick="window.open('<%=WebUtils.getContextPathURL(request)%>customer_status.ix');return false;"></i></span></a>
                                        </li>
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>customer_summary.ix"><span
                                                class="sws"><xms:localization
                                ...
                                <li><a href="#"><span><xms:localization text="Rankings"/></span><span
                                        class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li>
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>sales_rep_ranking.ix"><span
                                                class="sws"><xms:localization text="Sales Rep Rankings"/></span><span
                                                class="sws mgl"><i class="fa fa-external-link fa-fw sws pst"
                                                                   onclick="window.open('<%=WebUtils.getContextPathURL(request)%>sales_rep_ranking.ix');return false;"></i></span></a>
                                        </li>
                                    </ul>
                                </li>
                                <li><a href="#"><span><xms:localization text="Web Freight"/></span><span
                                        class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li>
                                ...
                                <li><a href="#"><span><xms:localization text="Warranty"/></span><span
                                        class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>webship_label.ix"><span
                                                class="sws"><xms:localization
                                                text="Web Freight History Report"/></span><span class="sws mgl"><i
                                                class="fa fa-external-link fa-fw sws pst"
                                                onclick="window.open('<%=WebUtils.getContextPathURL(request)%>webship_label.ix');return false;"></i></span></a>
                                        </li>
                                        <%-- <li><a href="<%=WebUtils.getContextPathURL(request)%>invoiced_airbill.ix"><span
                                                class="sws"><xms:localization
                                                text="Invoice History Report"/></span><span class="sws mgl"><i
                                                class="fa fa-external-link fa-fw sws pst"
                        ...
                        <li><a href="#" class="st"><i class="fa fa fa-user fa-fw"></i><span> <xms:localization
                                text="ADMIN"/></span> </a>
                            <ul class="dropdown-menu">
                                <li><a href="#"><span><xms:localization text="Rates and Fees"/></span><span
                                        class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>surcharge_list.ix"><span
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>rate_sheets.ix"><span
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>set_cost_basis.ix"><span
                                                class="sws"><xms:localization text="Set Cost Basis Tables"/></span><span
                                                class="sws mgl"><i class="fa fa-external-link fa-fw sws pst"
                                                                   onclick="window.open('<%=WebUtils.getContextPathURL(request)%>set_cost_basis.ix');return false;"></i></span></a>
                                        </li>
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>set_list_rates.ix"><span
                                ...
                                <li><a href="#"><span><xms:localization text="Logs"/></span><span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>system_log.ix"><span
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>system_stats.ix"><span
                                ...
                                <%-- <li><a href="#"><span><xms:localization text="Import"/></span><span
                                        class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="#" class="disabled-link"><span class="sws"><xms:localization
                                                text="Import Carrier Airbill Adjustment Responses"/></span><span
                                                class="sws mgl"><i class="fa fa-external-link fa-fw sws pst"></i></span></a>
                                        </li>
                                        <li>
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>reconcile_airbill.ix"><span
                                                class="sws"><xms:localization text="Reconcile Airbills"/></span><span
                                                class="sws mgl"><i class="fa fa-external-link fa-fw sws pst"
                                ...
                                <li><a href="#"><span><xms:localization text="System Settings"/></span><span
                                        class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>admin_menu.ix"><span
                                ...
                                <li><a href="#"><span><xms:localization text="Carriers"/></span><span
                                        class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>carrier_list.ix"><span
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>country_list.ix"><span
                                ...
                                <li><a href="#"><span><xms:localization text="Administration"/></span><span
                                        class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>franchise_setting.ix"><span
                                                class="sws"><xms:localization text="Franchise Settings"/></span><span
                                                class="sws mgl"><i class="fa fa-external-link fa-fw sws pst"
                                                                   onclick="window.open('<%=WebUtils.getContextPathURL(request)%>franchise_setting.ix');return false;"></i></span></a>
                                        </li>
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>admin_permission.ix"><span
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>admin_supply.ix"><span
                                ...
                                <li><a href="#"><span><xms:localization text="Generic Setup"/></span><span
                                        class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>email_template.ix"><span
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>industry_list.ix"><span
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>area_list.ix"><span
                                                class="sws"><xms:localization text="Area"/></span><span class="sws mgl"><i
                                                class="fa fa-external-link fa-fw sws pst"
                                                onclick="window.open('<%=WebUtils.getContextPathURL(request)%>area_list.ix');return false;"></i></span></a>
                                        </li>
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>language_value.ix"><span
                                        ...
                                        <li><a href="<%=WebUtils.getContextPathURL(request)%>territory_list.ix"><span
                ...
                <table class="s36">
                    <tr>
                        <%
                            ...
                            if (!adminLevel.equalsIgnoreCase("10.0")) {
                        %>
                        ...
                        %>
                        <td><a href="logout.ix" class="btn s37"><xms:localization text="Log out"/></a></td>
                    </tr>
                </table>
            </ol>
            <script type="text/javascript">
                ...
                function doQuickSearchForm() {
                    var quickSearchValue = $("#txtQuickSearchForm").val();
                    var quickSearchType = $("#searchTypeForm").val();
                    var data = {
                        "searchValue": quickSearchValue,
                        "searchType": quickSearchType
                    };
                    var action = "admin_quick_search_form.ix";
                    loadingDialog.dialog("open");
                    $.post(action + "?reqType=json", data, function (res) {
                        loadingDialog.dialog("close");
                        if (res.errorCode == "SUCCESS") {
                            $("#quickSearchResult").html(res.content);
                        } else {
                            alertDialog.html(res.errorMsg);
                            alertDialog.dialog("open");
                        }
