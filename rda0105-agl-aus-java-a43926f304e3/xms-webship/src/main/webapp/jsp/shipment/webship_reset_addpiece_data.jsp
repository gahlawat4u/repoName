...
<table class="s32 table table-striped table-bordered" border="" id="piece-table">
    ...
    <tr id="piece-dt<s:property value='%{#rowPiece.index+1}'/>">
        ...
        <td width="10%"><s:textfield name="shipmentPage.pieces[%{#rowPiece.index}].weight" placeholder=""
                                     class="form-control alloptions weight" data-placement="top" data-toggle="tooltip"
                ...
                <div class="col-lg-4 pd1">
                    <s:if test="%{shipmentTypePackage.allowDoxAddpiece == 0}">
                        <s:textfield name="shipmentPage.pieces[%{#rowPiece.index}].dimensionL"
                                     ...
                                     onkeypress="return formartNumber(event,this,false);" maxlength="4" disabled="true"
                        />
                    </s:if>
                    <s:else>
                        <s:textfield name="shipmentPage.pieces[%{#rowPiece.index}].dimensionL"
        ...
        <td width="25%"
            ...
            <s:textfield name="shipmentPage.pieces[%{#rowPiece.index}].customValue" value="0.00" placeholder=""
        ...
        <s:if test="%{shipmentTypePackage.allowDoxAddpiece != 0}">
            <td class="quantity"><s:textfield name="shipmentPage.pieces[%{#rowPiece.index}].quantity" value="1"
    ...
    <tr id="piece-dt1">
        ...
        <td width="40%">
            <div class="row mg0">
                <div class="col-lg-4 pd1">
                    <s:if test="%{shipmentTypePackage.allowDoxAddpiece == 0}">
                        <s:textfield name="shipmentPage.pieces[0].dimensionL" cssClass="form-control alloptions dimL"
                                     onkeypress="return formartNumber(event,this,false);" maxlength="4" disabled="true"
                                     />
                    </s:if>
                    <s:else>
                ...
                <div class="col-lg-4 pd1">
                    <s:if test="%{shipmentTypePackage.allowDoxAddpiece == 0}">
                        <s:textfield name="shipmentPage.pieces[0].dimensionW" cssClass="form-control alloptions dimW"
                                     onkeypress="return formartNumber(event,this,false);" maxlength="4" disabled="true"
                                     />
                    </s:if>
                    <s:else>
                ...
                <div class="col-lg-4 pd1">
                    <s:if test="%{shipmentTypePackage.allowDoxAddpiece == 0}">
                        <s:textfield name="shipmentPage.pieces[0].dimensionH" cssClass="form-control alloptions dimH"
                                     onkeypress="return formartNumber(event,this,false);" maxlength="4" disabled="true"
                                     />
                    </s:if>
                    <s:else>
        ...
        <s:if test="%{shipmentTypePackage.allowDoxAddpiece != 0}">
            <td class="quantity"><s:textfield name="shipmentPage.pieces[0].quantity" value="1" placeholder=""
                                              class="form-control quantity" data-placement="top" data-toggle="tooltip"
                                              data-original-title='<%=WebUtils.getTooltip(request, "Quantiy", ENCODE_TYPE.JAVASCRIPT)%>'
                                              onkeypress="return formartNumber(event,this,false);"/></td>
        </s:if>
        <s:if test="%{shipmentPage.serviceId == 3 || shipmentPage.serviceId == 400}">
            <td class="nonStandardPackage">
