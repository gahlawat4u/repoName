    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group">
                <label class="control-label" for="inputName"> <xms:localization text="Option"/> <span
                        class="s30">*</span>
                </label>
                <s:select id="ws-schedule-collection-select" name="shipmentRequestModel.scheduleCollectionSelect" list="collectionTypeList"
                          cssClass="form-control" listKey="collectionTypeId" listValue="collectionTypeName"
                          onchange="onScheduleCollectionChange()"/>
            </div>
        </div>
        <div id="ws-schedule-collection-div">
            <div class="col-lg-5">
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="control-label" for="inputName"> <xms:localization text="City"/> <span
                            class="s30">*</span>
                    </label>
                    <s:textfield value="%{shipmentRequestModel.shipmentInfo.senderAddress.city}"
                                 name="shipmentRequestModel.scheduleCollection.saddress.city"
                                 cssClass="form-control alloptions" data-placement="top" data-toggle="tooltip"
