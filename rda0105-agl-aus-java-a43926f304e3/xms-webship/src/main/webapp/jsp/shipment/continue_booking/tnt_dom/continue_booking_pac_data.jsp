                                            ...
                                            <div class="col-md-6 sd1 div_more_detail">
                                                <s:if test="quotable">
                                                    <table class="table s99" style="font-size: 13px;">
                                                        ...
                                                        <s:if test="shipmentRequestModel.quote.baseCharge != 0">
                                                            <tr>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <s:textfield id="total_shipment_value" name="shipmentRequestModel.quote.totalCustomValue"
