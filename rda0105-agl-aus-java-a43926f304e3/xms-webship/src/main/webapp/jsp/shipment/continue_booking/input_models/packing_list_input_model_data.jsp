...
<s:if test="packingListSelect==2">
    <div class="form-group ">
        <div style="min-width: 10px !important; overflow: auto">
            <table class="table  table-bordered mg0" id="packing_list_table">
                <tbody>
                <tr bgcolor="#F5F5F5">
                    <th class="txtNoOfCtns"><xms:localization text="No of CTNS"/><span style="color: red">*</span></th>
...
<s:elseif test="commercialInvoiceSelect==3">
    <div class="form-group ">
        <div style="min-width: 10px !important; overflow: auto">
            <table class="table  table-bordered mg0" id="packing_list_table">
                <tbody>
