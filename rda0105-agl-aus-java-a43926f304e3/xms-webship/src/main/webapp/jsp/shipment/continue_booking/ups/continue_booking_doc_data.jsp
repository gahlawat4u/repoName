                                            ...
                                            <s:if test="quotable">
                                                <table class="table s99" style="font-size: 13px;">
                                                    <tr>
                                                        ...
                                                        <s:if test="shipmentRequestModel.quote.totalCharge !=0 ">
                                                            <td class="td2"><s:property
                                                                    value="shipmentRequestModel.quote.totalCharge"/>
                                                                <br/>
                                                        ...
                                                        <td class="td2"><xms:localization
                                                                text="Cost will be advised later."/> <br/>
                                                            <i><u> <xms:localization
                                                                    text="(Quote is an estimate. Additional fees may apply.)"/>
                                                            </u></i></td>
                                                    </s:else>
                                                ...
                                                <s:if test="quotable">
                                                    <table class="table s99" style="font-size: 13px;">
                                                        ...
                                                        <s:if test="shipmentRequestModel.quote.totalCharge !=0 ">
                                                            ...
                                                            <td class="td1 s40 ncl"><xms:localization text="TBA"/></td>
                                                        </s:else>
                                                        </tbody>
                                                    </table>
                                                </s:if>
...
<script type="text/javascript">
    ...
    function doShip() {
        ...
        captionList.push('');
        captionList.push('<xms:localization text="Shipment Receipt" />'); */
