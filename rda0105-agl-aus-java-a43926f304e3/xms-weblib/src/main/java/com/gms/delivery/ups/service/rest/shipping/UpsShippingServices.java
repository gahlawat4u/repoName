...
import com.gms.delivery.ups.service.rest.shipment.pojo.response.ResponseStatus;
...
public class UpsShippingServices {
	 ...
	 * @param args
	 */
	//public ShippingResponse doShipment(ShippingRequest shippingRequestVo) {
	public String doShipment(ShippingRequest shippingRequestVo) {
		...
		//ShippingSHRoot shippingResponse = null;
		String outPut = "";
		String newout = "";
