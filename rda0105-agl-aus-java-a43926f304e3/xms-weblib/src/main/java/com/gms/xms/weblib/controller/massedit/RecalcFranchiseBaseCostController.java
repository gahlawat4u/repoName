...
/**
 * Posted from Jul 15, 2016 11:08:25 AM
 * <p>
 * Author huynd
 */
public class RecalcFranchiseBaseCostController extends MassEditController {
    ...
    public String recalculate() {
        try {
            ...
            for (ListAirbillForMassEditModel list : listAirbill) {
                ...
                service.recalcFranchiseBaseCost(this.getAddInfoMap(), Long.valueOf(list.getShipmentId()), list.getAirbillNumber(), iRecalculateCharge);
                count++;
            }
            this.setCount(count);
        } catch (Exception e) {
