 ...
 * Author huynd
 */
public class ForceQuotedAccessorialChargeController extends MassEditController {
    ...
    public String save() {
        try {
            ...
            for (ListAirbillForMassEditModel list : listAirbill) {
                service.forceQuotedAccessorialCharge(this.getAddInfoMap(), Long.valueOf(list.getShipmentId()), list.getAirbillNumber());
                count++;
            }
            this.setCount(count);
        } catch (Exception e) {
