...
/**
 * Posted from Aug 15, 2016 9:27:31 AM
 * <p>
 * Author huynd
 */
public class RecalcCustomerBaseChargeController extends MassEditController {
    ...
    public String recalculate() {
        try {
            ...
            for (ListAirbillForMassEditModel list : listAirbill) {
                ...
                service.recalcCustomerBaseCharge(this.getAddInfoMap(), Long.valueOf(list.getShipmentId()), list.getAirbillNumber(), iRecalculateCharge);
                count++;
            }
            this.setCount(count);
        } catch (Exception e) {
