...
/**
 * File Name: ManageFranchiseNotesController.java <br/>
 * Author: TANDT <br/>
 ...
 * Class: ManageFranchiseNotesController
 */
public class ManageFranchiseNotesController extends JsonBaseController {

    private static final long serialVersionUID = -7808952019071411038L;
    ...
    public void delete() {
        try {
            if (StringUtils.isBlank(noteId)) {
                throw new Exception("No note id");
            }
            INoteService noteService = new NoteServiceImp();
