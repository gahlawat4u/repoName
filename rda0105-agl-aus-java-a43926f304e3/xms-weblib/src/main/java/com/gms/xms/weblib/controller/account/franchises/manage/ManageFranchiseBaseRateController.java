...
/**
 * File Name: ManageFranchiseBaseRateController.java <br/>
 * Author: TANDT <br/>
 ...
 * Class: ManageFranchiseBaseRateController
 */
public class ManageFranchiseBaseRateController extends ManageFranchiseAccountSetupController {

    private static final long serialVersionUID = -1107479464422188596L;
    ...
    private void loadData() throws Exception {
        ...
        FranchiseVo franchiseVo = franchiseService.selectFranchiseByFranchiseCodeExt(customerCode);
        if (franchiseVo == null) {
            throw new Exception("Please choose a Franchise");
        }
        baseRateVo.setCustomerCode(franchiseVo.getFranchiseCode());
        baseRateVo.setMinimunBaseCharge(franchiseVo.getMinimunBaseCharge());
    ...
    protected boolean preapareCustomerDetail() throws Exception {
        if (StringUtils.isNotEmpty(customerCode)) {
            if (customerCode.equals("0")) {
                ...
                this.setCustomerModel(customerN);
            } else {
                ...
                this.setCustomerModel(ModelUtils.createModelFromVo(service.selectCustomerByFilter(filter), CustomerModel.class));
