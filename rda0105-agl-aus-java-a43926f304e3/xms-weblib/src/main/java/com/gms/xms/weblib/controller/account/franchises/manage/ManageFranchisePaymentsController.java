...
/**
 * File Name: ManageFranchisePaymentsController.java <br/>
 * Author: TANDT <br/>
 ...
 * Class: ManageFranchisePaymentsController
 */
public class ManageFranchisePaymentsController extends JsonBaseController {

    private static final long serialVersionUID = -1020188982709892099L;
    ...
    private void loadInvoiceDetail() throws Exception {
        if (StringUtils.isBlank(invoiceCode)) {
            throw new Exception("No invoice code");
        }
        IInvoiceService invoiceService = new InvoiceServiceImp();
