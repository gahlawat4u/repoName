...
/**
 * Posted from Aug 12, 2016 3:10:05 PM
 * <p>
 * Author huynd
 */
public class RecalcBaseChargeController extends MassEditController {
    ...
    public String recalculate() {
        try {
            ...
            for (ListAirbillForMassEditModel list : listAirbill) {
                ...
                service.recalcBaseCharge(this.getAddInfoMap(), Long.valueOf(list.getShipmentId()), list.getAirbillNumber(), iRecalculateCharge);
                count++;
            }
            this.setCount(count);
        } catch (Exception e) {
