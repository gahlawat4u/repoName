...
/**
 * Posted from ManageCustomerAddressController
 * <p>
 * Author DatTV Sep 10, 2015
 */
public class ManageCustomerAddressController extends JsonBaseController {
    ...
    protected boolean isValidCustomerAddressInfo() {
        ...
        if (customer.getAddress().getUserType() == null) {
            customer.getAddress().setUserType("false");
        }
    ...
    private void loadCustomerAddress() throws Exception {
        if (StringUtils.isBlank(customerCode)) {
            ...
            ICustomerService customerService = new CustomerServiceImp();
            ManageCustomerAddressVo customerVo = customerService.getManageCustomerAddressInfo(customerCode);
